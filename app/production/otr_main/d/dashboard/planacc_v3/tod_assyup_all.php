...
$tt_upassy = ($pn_otr / $pn_plan) * 100;
$tt_upassy = round($tt_upassy);

$at_upassy = $pn_target / $pn_count;
$at_upassy = round($at_upassy);

?>
<script>
    var chartDom = document.getElementById('today_upassy');
    var myChart = echarts.init(chartDom);
    var option;

    const gaugeDataTod_upassy = [{
            value: <?= $tt_upassy ?>,
            name: 'Today',
            title: {
                offsetCenter: ['-80%', '93%']
