...
$tt_painting = ($pn_otr / $pn_plan) * 100;
$tt_painting = round($tt_painting);

$at_painting = $pn_target / $pn_count;
$at_painting = round($at_painting);

?>
<script>
    var chartDom = document.getElementById('today_painting');
    var myChart = echarts.init(chartDom);
    var option;

    const gaugeDataTod_painting = [{
            value: <?= $tt_painting ?>,
            name: 'Today',
            title: {
                offsetCenter: ['-80%', '93%']
