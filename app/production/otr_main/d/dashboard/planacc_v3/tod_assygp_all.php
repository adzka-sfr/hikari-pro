...
$tt_gpassy = ($pn_otr / $pn_plan) * 100;
$tt_gpassy = round($tt_gpassy);

$at_gpassy = $pn_target / $pn_count;
$at_gpassy = round($at_gpassy);

?>
<script>
    var chartDom = document.getElementById('today_gpassy');
    var myChart = echarts.init(chartDom);
    var option;

    const gaugeDataTod_gpassy = [{
            value: <?= $tt_gpassy ?>,
            name: 'Today',
            title: {
                offsetCenter: ['-80%', '93%']
