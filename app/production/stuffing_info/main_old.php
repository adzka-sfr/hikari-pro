            ...
            <ul class="nav side-menu">
              ...
              <li><a><i class="fa fa-send-o"></i> Stuffing Info<span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                      ...
                      <li><a>Manage Stuffing Plan<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li class="sub_menu"><a href="main.php?page=addplanstuffing">Add Stuffing Plan</a>
                            </li>
                            <li><a href="#">Add PSI</a>
                            </li>
                            <li><a href="#">Edit Stuffing Plan</a>
                            </li>
                            <li><a href="#">Edit PSI</a>
                            </li>
                          </ul>
                        </li>
                      <li><a href="main.php?page=esodso">Picking Piano FG for ESO</a></li>
                      <!-- <li><a href="main.php?page=viewplan">Prod. Progress</a></li> -->
                      <li><a href="main.php?page=prostuffing">Stuffing Progress by PSI</a></li>
                      <li><a href="main.php?page=stuffing_acvmt">Stuffing Achievement by PSI</a></li>
                      <!-- <li><a href="main.php?page=sales_acvmt">Sales Achievement</a></li> -->
                      <li><a href="main.php?page=stckfg">Stock FG</a></li>
                      <li><a href="main.php?page=esoinfo">Picking Piano Info</a></li>
                      <li><a href="main.php?page=stuffingreport">Stuffing Report</a></li>
              ...
              <li><a><i class="fa fa-truck"></i>Container Booking</i><span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                      ...
                      <li><a href="main.php?page=booking_prog">Container Booking Info</a></li>
                      <!--
                      <li><a href="main.php?page=booking_prog">Booking Progress</a></li>
                      -->
                </ul>
              </li>
