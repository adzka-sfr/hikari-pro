<?php
$con_prodinfo    = new mysqli('localhost', 'root', '', 'prod_info');
$month = $_POST['month'];
$year = $_POST['year'];
//$month = date('m');
//$year = date('Y');
$str_ym = $year."-".$month."-01";
$cur_m = date('Y-m', strtotime($str_ym));
//$first_date_lastmont = date("Y-n-j", strtotime("first day of previous month"));
$first_date = new DateTime('first day of'.$cur_m);
$last_date = new DateTime('last day of'.$cur_m);
...
<script type="text/javascript">
    ...
    var option = {
        title: {
            text: 'Stuffing UP <?php echo date("M Y",strtotime($cur_m));?>',
        },
        grid: {
            bottom: 30
        },
    ...
    var option2 = {
        title: {
            text: 'Stuffing GP <?php echo date("M Y",strtotime($cur_m));?>',
        },
        grid: {
            bottom: 30
        },
