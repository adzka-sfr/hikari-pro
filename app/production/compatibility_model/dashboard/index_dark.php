...
<body class="nav-md footer_fixed" style="background-color: #263238;">
    ...
    <div class="right_col" role="main" style="background-color: #263238;">
        ...
        <div class="dashboard_graph" style="padding-bottom: 0px;">
            <div class="row">
                <div class="col-md-9">
                    <h2 style="font-weight: bold; padding-left: 10px; margin-top: 0px; font-size: 23px; color: #212529;">COMPATIBILITY MODEL <a href="index.php" style="margin-left: 10px;"><i class="fa fa-sun-o" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Tooltip on top"></i></a></h2>
                </div>
                <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="card w-100" style="background-color: #263238;">
                        <h1 style="font-weight: bold; padding-left: 20px; margin-top: 10px; margin-bottom: 0px; font-size: 30px; color: #FFFFFF;">FIXING FRAME |<u><span style="color: #FFFFFF;" id="hmbfixing"></span> <span style="color: #FFFFFF;">Unit</span></u>|</h1>
                ...
                <div class="col-6">
                    <div class="card w-100" style="background-color: #263238;">
                        <h1 style="font-weight: bold; padding-left: 20px; margin-top: 10px; margin-bottom: 0px; font-size: 30px; color: #FFFFFF;">STRINGING |<u><span style="color: #FFFFFF;" id="hmbstring"></span> <span style="color: #FFFFFF;">Unit</span></u>|</h1>
                        <div class="d-md-flex testimony-29101">
                            <div class="card-body">
                                <table class="table " style="font-size: 35px; background-color: #263238; color: #FFFF;">
