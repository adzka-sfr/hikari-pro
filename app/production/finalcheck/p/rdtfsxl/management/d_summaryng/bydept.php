...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: "management/d_summaryng/bydept/index.php",
            type: "POST",
            success: function(data) {
                $('#showpagebydept').html(data);
                // $('#loadingdatang').hide();
                $('#insidebydept').attr('disabled', true);
                $('#outsidebydept').attr('disabled', false);
            },
            error: function() {
                lostconnection()
            }
