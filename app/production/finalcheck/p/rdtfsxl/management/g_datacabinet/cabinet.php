            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Kabinet</h1>
                    </div>
                        ...
                        <form id="myform">
                            <div class="row">
                                <div class="col-12 mb-1">
                                    ...
                                    <textarea id="cabinetname" class="form-control"></textarea>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="tambahngbtn" onclick="tambahdatang()" class="btn btn-primary">Add Cabinet <i id="icon-spinner-add" style="display: none;" class="fa fa-spinner fa-spin"></i></button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function loaddata() {
        // get data inside
        $.ajax({
            url: "management/g_datacabinet/cabinet/index.php",
            type: "POST",
            success: function(data) {
                $('#insideshow').show();
                $('#add').show();
