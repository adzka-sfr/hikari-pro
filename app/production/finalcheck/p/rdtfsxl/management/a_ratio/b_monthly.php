...
<div class="row">
    <h5 style="color: #464646; font-weight: bold;">Status Temuan Inside (<?= date('F', strtotime($now)) ?>)</h5>
...
<hr>
<div class="row">
    <h5 style="color: #464646; font-weight: bold;">Status Temuan Completeness (<?= date('F', strtotime($now)) ?>)</h5>
...
<hr>
<div class="row">
    <h5 style="color: #464646; font-weight: bold;">Status Temuan Outside (<?= date('F', strtotime($now)) ?>)</h5>
...
<script>
    // get data inside
    $.ajax({
        url: "management/a_ratio/chart/m_inside.php",
        type: "POST",
    ...
    $.ajax({
        url: "management/a_ratio/chart/m_completeness.php",
        type: "POST",
        success: function(data) {
            $('#completeness').show();
    ...
    // get data outsdie
    $.ajax({
        url: "management/a_ratio/chart/m_outside.php",
        type: "POST",
        success: function(data) {
            $('#outside').show();
            $('#loadingoutside').hide();
