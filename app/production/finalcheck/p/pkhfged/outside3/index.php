                    ...
                    success: function(response) {
                        ...
                        if (response.status == 'tidak-ada') {
                            ...
                            Swal.fire({
                                ...
                                text: 'Pastikan anda melakukan scan pada QR-Code yang diterbitkan oleh Outside Check2',
                                icon: 'error',
                                // timer: 3000,
...
<script>
    ...
    function load_data_ngclose(serialnumber) {
        $.ajax({
            type: 'POST',
            url: 'outside3/detail_ngclose.php',
            data: {
                "serialnumber": serialnumber
            },
            success: function(response) {
    ...
    function load_image_ngclose(serialnumber, codetype) {
        $.ajax({
            type: 'POST',
            url: 'outside3/image_ngclose.php',
            data: {
                "serialnumber": serialnumber,
                "codetype": codetype
            },
