    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td style="font-size: 15px; text-align: center;"><input disabled id="cekbok2<?= $data['c_code_completeness'] ?>" onchange="cekbok2(this.id)" value="<?= $data['c_code_completeness'] ?>" type="checkbox" <?= $checkcom2 ?> style="transform: scale(2);"></td>
                <td style="font-size: 15px; text-align: center;"><input id="cekbok3<?= $data['c_code_completeness'] ?>" onchange="cekbok3(this.id)" value="<?= $data['c_code_completeness'] ?>" type="checkbox" <?= $checkcom3 ?> style="transform: scale(2);"></td>
            </tr>
        <?php
        }
        ?>
...
<div class="row">
    ...
    <div class="col-4">
        <h5>Note 3</h5>
        <textarea name="note3" id="note3" rows="5" style="width: 100%;"></textarea>
    </div>
