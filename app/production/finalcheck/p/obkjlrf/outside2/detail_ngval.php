...
$sql2 = mysqli_query($connect_pro, "SELECT a.c_repair_outsidedua_o , b.c_outsidedua, a.c_outsidedua_pic  FROM finalcheck_repairtime a INNER JOIN finalcheck_pic b ON a.c_serialnumber = b.c_serialnumber WHERE b.c_serialnumber = '$serialnumber'");
$data2 = mysqli_fetch_array($sql2);
$ok_date = '-';
$pic = $data2['c_outsidedua'];
$repair = '-';
