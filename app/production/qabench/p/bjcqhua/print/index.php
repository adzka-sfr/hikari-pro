...
<div class="row">
    <div class="col-8">
        <div class="row">
            <div class="col-12">
                <label class="control-label col-md-4" for="first-name">Name of Bench <br>
                    <span id="optionerror" style="color: red; display: none;">Silahkan memilih jenis bench</span>
                    </span>
                </label>
                <div class="col-md-8">
                    <select class="cari_basic" style="width: 100% " id="gmc">
                        <option></option>
                        <?php
                        $username = "B_ACTY";
                        $password = "SYSTEM";
        ...
        <div class="row">
            <div class="col-12">
                <label class="control-label col-md-4 mt-3" for="first-name">QTY <br>
                    <span id="qtyerror" style="color: red; display: none;">Silahkan memasukkan qty</span>
                    </span>
                </label>
                <div class="col-md-2 mt-3">
                    <input id="qty" style="text-align: center; border-radius: 5px;" type="text" class="form-control" placeholder="QTY" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                </div>
            </div>
        </div>
    </div>
        ...
        $('#print').click(function() {
            ...
            if (bench == '' && qty == '') {
                ...
                Swal.fire({
                    ...
                    icon: 'question',
                    html: 'Print label untuk <b>' + bench + '</b><br>sebanyak <b>' + qty + '</b> pcs',
