                ...
                <div class="left_col scroll-view">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "register") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=register"><i class="fa fa-barcode"></i> Register</a>
                                </li>
                            </ul>
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "packing") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=packing"><i class="fa fa-dropbox"></i> Packing</a>
                                </li>
                            </ul>
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "staking" or $_GET['page'] == "resultst") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=staking"><i class="fa fa-calculator"></i> Stock Taking</a>
                                </li>
                            </ul>
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "history") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=history"><i class="fa fa-clock-o"></i> History</a>
                                </li>
                            </ul>
                        </div>
