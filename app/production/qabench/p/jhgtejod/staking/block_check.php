...
if ($d1['c_status'] == 0) {
    ...
    // cek apakah fitur staking tersedia
    $q2 = mysqli_query($connect_pro, "SELECT c_status, c_message FROM qa_fitur WHERE c_fitur = 'staking' AND c_location = '$location'");
    $d2 = mysqli_fetch_array($q2);
    if ($d2['c_status'] == 0) {
        // echo "staking-disable";
        echo json_encode(array("status" => "staking-disable", "message" => $d2['c_message']));
    } else {
        // echo "oke";
