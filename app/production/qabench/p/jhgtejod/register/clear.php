...
$q1 = mysqli_query($connect_pro, "SELECT COUNT(id) as isi FROM qa_preregister_pre_pre WHERE c_location = '$location'");
...
if ($d1['isi'] == 0) {
    ...
    $sql = mysqli_query($connect_pro, "DELETE FROM qa_preregister_pre_pre WHERE c_location = '$location'");
    if ($sql) {
        // echo "clear-berhasil";
