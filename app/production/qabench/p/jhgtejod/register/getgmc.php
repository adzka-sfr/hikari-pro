...
$q1 = mysqli_query($connect_pro, "SELECT COUNT(c_gmc) as isi FROM qa_preregister_pre_pre");
$d1 = mysqli_fetch_array($q1);

if ($d1['isi'] == 0) {
    $gmclock = "-";
} else {
    $sql = mysqli_query($connect_pro, "SELECT DISTINCT c_gmc, c_name FROM qa_preregister_pre_pre");
