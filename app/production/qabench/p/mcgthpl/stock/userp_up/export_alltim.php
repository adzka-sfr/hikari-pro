...
// membuat sheet baru
$sheet = new \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet($spreadsheet, 'User Package Used - ' . $anjay); //deklarasi nama sheet
...
$sheet->setCellValue('B2', ': User Package Used by ' . $status . ' (' . $anjay . ')');
...
$tgle = date('Y-m-d');
$filename = 'User Package Used - ' . $anjay . '.xlsx';
try {
