...
// membuat sheet baru
$sheet = new \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet($spreadsheet, 'Stock User Package UP'); //deklarasi nama sheet
...
$sheet->setCellValue('B2', ': Stock User Package UP - ' . date('Y-m-d', strtotime($now)));
...
$tgle = date('y-m-d');
$filename = 'Stock User Package UP-' . $tgle . '.xlsx';
try {
