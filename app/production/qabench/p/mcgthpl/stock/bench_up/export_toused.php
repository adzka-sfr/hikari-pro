...
// membuat sheet baru
$sheet = new \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet($spreadsheet, 'Bench Used Today (UP'); //deklarasi nama sheet
...
$sheet->setCellValue('B2', ': Bench Used Today (UP) - ' . date('y-m-d', strtotime($now)));
...
$tgle = date('Y-m-d');
$filename = 'Bench Used Today (UP).xlsx';
try {
