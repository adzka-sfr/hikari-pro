    ...
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-4" style="text-align: right;">
                <a href="main.php?page=adjust-bench"><button class="btn btn-sm btn-warning">Adjust</button></a>
                <a href="main.php?page=log-bench"><button class="btn btn-sm btn-info">Log</button></a>
            </div>
        </div>
    ...
    <div class="col-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="main.php?page=st-bench-stckup">Show detail</a>
            </div>
        </div>
    </div>
    <div class="col-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- <p class="card-text">Show detail</p> -->
                <a href="main.php?page=st-bench-tousedup">Show detail</a>
            </div>
        </div>
    </div>
    <div class="col-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- <p class="card-text">Show detail</p> -->
                <a href="main.php?page=st-bench-alltimup">Show detail</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- <p class="card-text">Show detail</p> -->
                <a href="main.php?page=st-bench-stckgp">Show detail</a>
            </div>
        </div>
    </div>
    <div class="col-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- <p class="card-text">Show detail</p> -->
                <a href="main.php?page=st-bench-tousedgp">Show detail</a>
            </div>
        </div>
    </div>
    <div class="col-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- <p class="card-text">Show detail</p> -->
                <a href="main.php?page=st-bench-alltimgp">Show detail</a>
            </div>
        </div>
    </div>
</div>
