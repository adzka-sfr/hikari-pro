<div class="row">
    <div class="col-12">
        <h5><a href="main.php?page=st-userpac">User Package Stock</a> <i class="fa fa-chevron-right"></i> GP Stock</h5>
        <hr>
    </div>
</div>
<div class="row">
        ...
        <div class="row">
            <div class="col-12" style="padding-left:35px;">
                ...
                <script>
                    ...
                    function all2o() {
                        myWindow = window.open("stock/userp_gp/export_stock.php", "_blank");
                    }
                </script>
            </div>
        </div>
