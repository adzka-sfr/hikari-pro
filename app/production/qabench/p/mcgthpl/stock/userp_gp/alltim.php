<div class="row">
    <div class="col-12">
        <h5><a href="main.php?page=st-userpac">User Package Stock</a> <i class="fa fa-chevron-right"></i> GP All Time Used</h5>
        <hr>
    </div>
</div>
<div class="row">
    ...
    <div class="col-12">
            ...
            $(document).ready(function() {
                $('#infostock').DataTable({
                    ...
                    "buttons": [{
                            ...
                            title: "GP All Time Used (User Package) <?= $date_now ?>",
        ...
        <table class="table table-bordered" id="infostock">
            ...
            <tbody>
                <?php
                $no = 0;
                $sql = mysqli_query($connect_pro, "SELECT * FROM qa_userp WHERE c_used IS NOT NULL AND c_packed IS NOT NULL AND c_location = 'packing gp' ORDER BY c_packed DESC");
