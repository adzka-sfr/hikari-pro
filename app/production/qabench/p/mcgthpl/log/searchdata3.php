...
$_SESSION['loguserp_export_start'] = $startdate;
$_SESSION['loguserp_export_end'] = $enddate;
...
function fetch_data()
{
    ...
    global $enddate;
    // global $location;
    $query = "SELECT * FROM qa_log WHERE c_date >= '$startdate' AND c_date <= '$enddate' AND  c_gmcuserp != '-' AND c_action = 'packing' OR c_date >= '$startdate' AND c_date <= '$enddate' AND c_gmcuserp != '-' AND c_action = 'register' ORDER BY c_date DESC";
...
function show_data($fetchData)
{
    ...
    <script>
                                        ...
                                        function all2o() {
                                            myWindow = window.open("log/export_loguserp.php", "_blank");
                                        }
