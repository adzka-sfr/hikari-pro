    ...
    <div class="col-12">
            ...
            $(document).ready(function() {
                $('#infostock').DataTable({
                    ...
                    "buttons": [{
                            ...
                            title: "Stock Taking GP <?= $date_now ?>",
        ...
        <table class="table table-bordered" id="infostock">
            ...
            <tbody>
                <?php
                $no = 0;
                $sql = mysqli_query($connect_pro, "SELECT * FROM qa_staking WHERE c_location = 'packing gp' ORDER BY c_date DESC");
