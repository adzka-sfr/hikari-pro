<div class="row">
    <div class="col-12">
        <h5><a href="main.php?page=st-userpac">User Package Stock</a> <i class="fa fa-chevron-right"></i> Log</h5>
        <hr>
    </div>
</div>
<div class="row">
    ...
    <div class="col-12 mb-5">
            ...
            $(document).ready(function() {
                $('#infostock').DataTable({
                    ...
                    "buttons": [{
                            ...
                            title: "UP Log (User Package) <?= $date_now ?>",
        ...
        <table class="table table-bordered" id="infostock">
            ...
            <tbody>
                <?php
                $no = 0;
                $sql = mysqli_query($connect_pro, "SELECT * FROM qa_log WHERE  c_gmcuserp != '-' AND c_action = 'packing' OR c_gmcuserp != '-' AND c_action = 'register' ORDER BY c_date DESC");
