                ...
                <div class="left_col scroll-view">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "dashboard-up") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=dashboard-up"><i class="fa fa-music"></i> Packing UP</a>
                                </li>
                            </ul>
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "dashboard-gp") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=dashboard-gp"><i class="fa fa-music"></i> Packing GP</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="menu_section">
                            <h3>Stock Info</h3>
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "st-bench") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=st-bench"><i class="fa fa-dropbox"></i>Bench</a>
                                </li>
                            </ul>
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "st-userpac") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=st-userpac"><i class="fa fa-dropbox"></i>User Package</a>
                                </li>
                            </ul>
                        </div>

                        <div class="menu_section">
                            <h3>Stock Taking Info</h3>
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "st-info-up") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=st-info-up"><i class="fa fa-tty"></i>UP Area</a>
                                </li>
                            </ul>
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "st-info-gp") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=st-info-gp"><i class="fa fa-tty"></i>GP Area</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="menu_section">
                            <h3>Settings</h3>
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "control") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=control"><i class="fa fa-key"></i>Function Control</a>
                                </li>
                            </ul>
                            <!-- <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "emcon") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=emcon"><i class="fa fa-envelope"></i>Email Control</a>
                                </li>
                            </ul> -->
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "respac") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=respac"><i class="fa fa-exclamation-triangle"></i>Packing Reset</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="menu_section">
                            <h3>Log</h3>
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "errlog") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=errlog"><i class="fa fa-thumbs-down"></i>Error Log</a>
                                </li>
                            </ul>
                        </div>
