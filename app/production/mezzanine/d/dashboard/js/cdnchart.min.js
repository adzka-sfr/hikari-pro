...
! function (t, e) {
    ...
    function L(t) {
        T || (T = function () {
            ...
            for (n = 0; n < e.length; n++) {
                for (a = r = e[n], o = 0; o < i.length; o++) s = i[o], r = r.replace(s, A[s]);
                s = parseInt(O[a], 16), t[r] = [s >> 16 & 255, s >> 8 & 255, 255 & s]
            }
            return t
    ...
    class z {
        constructor(t) {
            ...
            })), i = o || L(t) || F(t)), this._rgb = i, this._valid = !!i
        }
        get valid() {
            return this._valid
        }
    ...
    var mt = new class {
        constructor(t) {
            this.animation = void 0, this.backgroundColor = "rgba(0,0,0,0.1)", this.borderColor = "rgba(0,0,0,0.1)", this.color = "#666", this.datasets = {}, this.devicePixelRatio = t => t.chart.platform.getDevicePixelRatio(), this.elements = {}, this.events = ["mousemove", "mouseout", "click", "touchstart", "touchmove"], this.font = {
                ...
                lineHeight: 1.2,
                weight: null
            }, this.hover = {}, this.hoverBackgroundColor = (t, e) => H(e.backgroundColor), this.hoverBorderColor = (t, e) => H(e.borderColor), this.hoverColor = (t, e) => H(e.color), this.indexAxis = "x", this.interaction = {
                mode: "nearest",
                intersect: !0
    ...
    function Yt(t, e, i, n) {
        ...
        for (l = 0; l < r; l++)
            ...
            for (c = 0, h = d.length; c < h; c++) u = d[c], null == u || Y(u) || (a = $t(t, o, s, a, u));
        t.restore();
        const f = s.length / 2;
        if (f > i.length) {
        ...
        if (!(isNaN(d) || d <= 0)) {
            switch (t.beginPath(), c) {
                ...
                case "triangle":
                    ...
                    break;
                case "rectRounded":
                    l = .516 * d, r = d - l, s = Math.cos(u + wt) * r, a = Math.sin(u + wt) * r, t.arc(i - s, n - a, l, u - xt, u - Mt), t.arc(i + a, n - s, l, u - Mt, u), t.arc(i + s, n + a, l, u, u + Mt), t.arc(i - a, n + s, l, u + Mt, u + xt), t.closePath();
                    break;
                case "rect":
                    if (!h) {
                ...
                case "cross":
                    ...
                    break;
                case "star":
                    s = Math.cos(u) * d, a = Math.sin(u) * d, t.moveTo(i - s, n - a), t.lineTo(i + s, n + a), t.moveTo(i + a, n - s), t.lineTo(i - a, n + s), u += wt, s = Math.cos(u) * d, a = Math.sin(u) * d, t.moveTo(i - s, n - a), t.lineTo(i + s, n + a), t.moveTo(i + a, n - s), t.lineTo(i - a, n + s);
                    break;
                case "line":
    ...
    function re(t, e) {
        ...
        if (!i) return;
        const n = i.listeners,
            o = n.indexOf(e); - 1 !== o && n.splice(o, 1), n.length > 0 || (se.forEach((e => {
            delete t[e]
        })), delete t._chartjs)
    }
    ...
    function pe(t, e) {
        ...
        } = e, o = de(i), s = "border-box" === o.boxSizing, a = ge(o, "padding"), r = ge(o, "border", "width"), {
            x: l,
            y: c,
            box: h
        } = function (t, e) {
    ...
    function xe(t, e, i, n) {
                ...
                if (void 0 === e || void 0 === i) {
                    ...
                    if (s) {
                        const t = s.getBoundingClientRect(),
                            ...
                            r = ge(a, "border", "width"),
                            l = ge(a, "padding");
                        e = t.width - l.width - r.width, i = t.height - l.height - r.height, n = he(a.maxWidth, s, "clientWidth"), o = he(a.maxHeight, s, "clientHeight")
        ...
        return c = Math.max(0, c - s.width), h = Math.max(0, n ? Math.floor(c / n) : h - s.height), c = me(Math.min(c, a, l.maxWidth)), h = me(Math.min(h, r, l.maxHeight)), c && !h && (h = me(c / 2)), {
            width: c,
            height: h
        }
    }
    ...
    function ke(t, e, i, n) {
        ...
        return we(t, i, e, (function (t, i, s) {
    ...
    function Se(t, e, i, n, o) {
        ...
        return we(t, i, e, (function (t, i, l) {
    ...
    function je(t, e, i) {
        ...
        i.size && (t[i.pos] -= i.size), i.size = i.horizontal ? n.height : n.width, t[i.pos] += i.size, n.getPadding && Ne(o, n.getPadding());
    ...
    function Ye(t, e, i) {
        ...
        for (o = 0, s = t.length, l = 0; o < s; ++o) {
            a = t[o], r = a.box, r.update(a.width || e.w, a.height || e.h, $e(a.horizontal, e));
            const {
                same: s,
                other: h
            } = je(e, i, a);
    ...
    var Xe = {
        ...
        update(t, e, i, n) {
            ...
            const o = Re(t.options.layout.padding),
                ...
                r = function (t) {
                    const e = function (t) {
                        ...
                        i = We(e.filter((t => t.box.fullSize)), !0),
                        n = We(Ve(e, "left"), !0),
                        o = We(Ve(e, "right")),
                        s = We(Ve(e, "top"), !0),
                        a = We(Ve(e, "bottom")),
            ...
            ! function (t, e) {
            ...
            }(l.concat(c), d), Ye(r.fullSize, f, d), Ye(l, f, d), Ye(c, f, d) && Ye(l, f, d),
                function (t) {
                ...
                }(f), Ue(r.leftAndTop, f, d), f.x += f.w, f.y += f.h, Ue(r.rightAndBottom, f, d), t.chartArea = {
                    left: f.left,
                    top: f.top,
                    right: f.left + f.w,
                    bottom: f.top + f.h,
        ...
        acquireContext(t, e) {
            ...
            return i && i.canvas === t ? (function (t, e) {
                ...
                if (t.$chartjs = {
                    ...
                    }, i.display = i.display || "block", i.boxSizing = i.boxSizing || "border-box", Ze(o)) {
                    const e = ye(t, "width");
                    void 0 !== e && (t.width = e)
                }
                if (Ze(n))
    ...
    const hi = t => 0 === t || 1 === t,
        di = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * bt / i),
        ui = (t, e, i) => Math.pow(2, -10 * t) * Math.sin((t - e) * bt / i) + 1,
            ...
            easeInElastic: t => hi(t) ? t : di(t, .075, .3),
            easeOutElastic: t => hi(t) ? t : ui(t, .075, .3),
            easeInOutElastic(t) {
                const e = .1125;
                return hi(t) ? t : t < .5 ? .5 * di(2 * t, e, .45) : .5 + .5 * ui(2 * t - 1, e, .45)
            },
            easeInBack(t) {
                const e = 1.70158;
                return t * t * ((e + 1) * t - e)
    ...
    class mi {
        constructor(t, e, i, n) {
            ...
            this._active = !0, this._fn = t.fn || pi[t.type || typeof s], this._easing = fi[t.easing] || fi.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = i, this._from = s, this._to = n, this._promises = void 0
        }
        active() {
            return this._active
        }
        update(t, e, i) {
            ...
            if (n._active) {
                ...
                const o = n._target[n._prop],
                    s = i - n._start,
                    a = n._duration - s;
                n._start = i, n._duration = Math.floor(Math.max(a, t.duration)), n._total += s, n._loop = !!t.loop, n._to = Ie([t.to, e, o, t.from]), n._from = Ie([t.from, o, e])
            }
        }
        cancel() {
            const t = this;
    ...
    class bi {
        ...
        _createAnimations(t, e) {
            ...
            for (r = s.length - 1; r >= 0; --r) {
                ...
                d && d.duration ? (o[l] = h = new mi(d, t, l, c), n.push(h)) : t[l] = c
            }
            return n
        }
        update(t, e) {
    ...
    class Ai {
        ...
        initialize() {
            const t = this,
                e = t._cachedMeta;
            t.configure(), t.linkScales(), e._stacked = Mi(e.vScale, e), t.addElements()
        }
        updateIndex(t) {
            this.index = t
        }
        ...
        _dataCheck() {
            ...
            U(i) ? t._data = function (t) {
                ...
                return i
            }(i) : t._data !== i && (t._data && (re(t._data, t), Pi(t._cachedMeta)), i && Object.isExtensible(i) && ae(i, t), t._data = i)
        }
        addElements() {
            const t = this,
                e = t._cachedMeta;
        ...
        buildOrUpdateElements(t) {
            const e = this,
                ...
                n = e.getDataset();
            let o = !1;
            e._dataCheck(), i._stacked = Mi(i.vScale, i), i.stack !== n.stack && (o = !0, Pi(i), i.stack = n.stack), e._resyncElements(t), o && ki(e, i._parsed)
        }
        configure() {
            const t = this,
                e = t.chart.config,
        ...
        updateRangeFromParsed(t, e, i, n) {
            ...
            n && a && (n.values = a, t.min = Math.min(t.min, s), t.max = Math.max(t.max, s), s = vi(n, o, this._cachedMeta.index, {
                all: !0
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return g.$shared && (g.$shared = l, s[a] = Object.freeze(Ci(g, l))), g
        }
    ...
    Ai.defaults = {}, Ai.prototype.datasetElementType = null, Ai.prototype.dataElementType = null;
    class Oi {
        constructor() {
    ...
    const Ri = {
        ...
        logarithmic(t, e, i) {
            ...
            return 1 === n || 2 === n || 5 === n ? Ri.numeric.call(this, t, e, i) : ""
        }
    };
    var Ei = {
        formatters: Ri
    ...
    function Ii(t, e) {
        ...
        if (s > 0) {
            ...
            for (Fi(e, l, c, $(n) ? 0 : a - n, a), t = 0, i = s - 1; t < i; t++) Fi(e, l, c, o[t], o[t + 1]);
    ...
    class ji extends Oi {
        constructor(t) {
            super(), this.id = t.id, this.type = t.type, this.options = void 0, this.ctx = t.ctx, this.chart = t.chart, this.top = void 0, this.bottom = void 0, this.left = void 0, this.right = void 0, this.width = void 0, this.height = void 0, this._margins = {
                ...
                top: 0,
                bottom: 0
            }, this.maxWidth = void 0, this.maxHeight = void 0, this.paddingTop = void 0, this.paddingBottom = void 0, this.paddingLeft = void 0, this.paddingRight = void 0, this.axis = void 0, this.labelRotation = void 0, this.min = void 0, this.max = void 0, this.ticks = [], this._gridLineItems = null, this._labelItems = null, this._labelSizes = null, this._length = 0, this._maxLength = 0, this._longestTextCache = {}, this._startPixel = void 0, this._endPixel = void 0, this._reversePixels = !1, this._userMax = void 0, this._userMin = void 0, this._suggestedMax = void 0, this._suggestedMin = void 0, this._ticksLength = 0, this._borderValue = 0, this._cache = {}, this._dataLimitsCached = !1, this.$context = void 0
        }
        init(t) {
            const e = this;
            e.options = t, e.axis = t.axis, e._userMin = e.parse(t.min), e._userMax = e.parse(t.max), e._suggestedMin = e.parse(t.suggestedMin), e._suggestedMax = e.parse(t.suggestedMax)
        }
        parse(t, e) {
            return t
        }
        ...
        update(t, e, i) {
            ...
            n.beforeUpdate(), n.maxWidth = t, n.maxHeight = e, n._margins = i = Object.assign({
                ...
                top: 0,
                bottom: 0
            }, i), n.ticks = null, n._labelSizes = null, n._gridLineItems = null, n._labelItems = null, n.beforeSetDimensions(), n.setDimensions(), n.afterSetDimensions(), n._maxLength = n.isHorizontal() ? n.width + i.left + i.right : n.height + i.top + i.bottom, n._dataLimitsCached || (n.beforeDataLimits(), n.determineDataLimits(), n.afterDataLimits(), n._dataLimitsCached = !0), n.beforeBuildTicks(), n.ticks = n.buildTicks() || [], n.afterBuildTicks();
            const a = s < n.ticks.length;
            n._convertTicksToLabels(a ? Vi(n.ticks, s) : n.ticks), n.configure(), n.beforeCalculateLabelRotation(), n.calculateLabelRotation(), n.afterCalculateLabelRotation(), o.display && (o.autoSkip || "auto" === o.source) && (n.ticks = Ii(n, n.ticks), n._labelSizes = null), a && n._convertTicksToLabels(n.ticks), n.beforeFit(), n.fit(), n.afterFit(), n.afterUpdate()
        }
        configure() {
            const t = this;
        ...
        calculateLabelRotation() {
            ...
            a = e.offset ? t.maxWidth / n : f / (n - 1), d + 6 > a && (a = f / (n - (e.offset ? .5 : 1)), r = t.maxHeight - Wi(e.grid) - i.padding - Hi(e.title, t.chart.options.font), l = Math.sqrt(d * d + u * u), c = Et(Math.min(Math.asin(Math.min((h.highest.height + 6) / a, 1)), Math.asin(Math.min(r / l, 1)) - Math.asin(u / l))), c = Math.max(o, Math.min(s, c))), t.labelRotation = c
        }
        ...
        fit() {
            ...
            if (a) {
                ...
                if (r ? (e.width = t.maxWidth, e.height = Wi(s) + a) : (e.height = t.maxHeight, e.width = Wi(s) + a), n.display && t.ticks.length) {
                    const {
                        first: i,
                        last: o,
                        widest: s,
                        highest: a
                    } = t._getLabelSizes(), l = 2 * n.padding, c = Rt(t.labelRotation), h = Math.cos(c), d = Math.sin(c);
                    if (r) {
        ...
        _getLabelSizes() {
            ...
            if (!e) {
                ...
                let n = t.ticks;
                i < n.length && (n = Vi(n, i)), t._labelSizes = e = t._computeLabelSizes(n, n.length)
            }
            return e
        }
        _computeLabelSizes(t, e) {
            ...
            for (a = 0; a < e; ++a) {
                if (c = t[a].label, h = this._resolveTickFontOptions(a), i.font = d = h.string, u = n[d] = n[d] || {
                    ...
                    if (Y(c))
                        for (r = 0, l = c.length; r < l; ++r) m = c[r], $(m) || Y(m) || (g = $t(i, u.data, u.gc, g, m), p += f)
        ...
        _computeGridLineItems(t) {
            ...
            if ("top" === a) m = p(e.bottom), v = e.bottom - h, w = m - g, S = p(t.top) + g, D = t.bottom;
            else if ("bottom" === a) m = p(e.top), S = t.top, D = p(t.bottom) - g, v = m + g, w = e.top + h;
            else if ("left" === a) m = p(e.right), y = e.right - h, M = m - g, k = p(t.left) + g, P = t.right;
            else if ("right" === a) m = p(e.left), k = t.left, P = p(t.right) - g, y = m + g, M = e.left + h;
            else if ("x" === i) {
            ...
            for (x = 0; x < c; ++x) {
                ...
                b = Bi(e, x, r), void 0 !== b && (_ = Ut(n, b, i), l ? y = M = k = P = _ : v = w = S = D = _, d.push({
                    tx1: y,
                    ty1: v,
                    tx2: M,
                    ty2: w,
        ...
        _computeLabelItems(t) {
            const e = this,
                ...
                g = [];
            let p, m, x, b, _, y, v, M, w, k, S, P, D = "middle";
            ...
            "y" === i && ("start" === l ? D = "top" : "end" === l && (D = "bottom"));
            const C = e._getLabelSizes();
            for (p = 0, m = r.length; p < m; ++p) {
                x = r[p], b = x.label;
                const t = s.setContext(e.getContext(p));
                M = e.getPixelForTick(p) + s.labelOffset, w = e._resolveTickFontOptions(p), k = w.lineHeight, S = Y(b) ? b.length : 1;
                const i = S / 2,
                    n = t.color,
                    l = t.textStrokeColor,
                    h = t.textStrokeWidth;
                a ? (_ = M, P = "top" === o ? "near" === c || 0 !== f ? -S * k + k / 2 : "center" === c ? -C.highest.height / 2 - i * k + k : -C.highest.height + k / 2 : "near" === c || 0 !== f ? k / 2 : "center" === c ? C.highest.height / 2 - i * k : C.highest.height - S * k) : (y = M, P = (1 - S) * k / 2), g.push({
                    rotation: f,
                    label: b,
                    font: w,
                    color: n,
        ...
        drawGrid(t) {
            ...
            if (a) {
                const t = i.setContext(e.getContext(e._ticksLength - 1)),
                    ...
                    s = e._borderValue;
                let r, l, c, d;
                e.isHorizontal() ? (r = Ut(o, e.left, a) - a / 2, l = Ut(o, e.right, n) + n / 2, c = d = s) : (c = Ut(o, e.top, a) - a / 2, d = Ut(o, e.bottom, n) + n / 2, r = l = s), h({
                    x: r,
                    y: c
                }, {
                    x: l,
        ...
        drawTitle() {
            ...
            const {
                ...
                let c, h, d, u = 0;
                return t.isHorizontal() ? (h = o(n, a, l), d = zi(t, i, e), c = l - a) : (h = zi(t, i, e), d = o(n, r, s), u = "left" === i ? -Mt : Mt), {
                    titleX: h,
                    titleY: d,
                    maxWidth: c,
                    rotation: u
    ...
    function $i(t, e = [""], i = t, n) {
        ...
        return new Proxy(o, {
            ...
            get: (i, n) => Ki(i, n, (() => function (t, e, i, n) {
                let o;
                for (const s of e)
                    if (o = en(Xi(s, t), i), ht(o)) return qi(t, o) ? Ji(i, n, t, o) : o
            }(n, e, t, i))),
    ...
    function Yi(t, e, i, n) {
        ...
        return new Proxy(o, {
            ...
            get: (t, e, i) => Ki(t, e, (() => function (t, e, i) {
                const {
                    _proxy: n,
                    _context: o,
                    _subProxy: s,
                ...
                dt(r) && a.isScriptable(e) && (r = function (t, e, i, n) {
                    ...
                    r.add(t), e = e(s, a || n), r.delete(t), U(e) && (e = Ji(o._scopes, o, t, e));
                    return e
                }(e, r, t, i));
    ...
    const Zi = (t, e) => !0 === t ? e : "string" == typeof t ? lt(e, t) : void 0;
    ...
    function Ji(t, e, i, n) {
        const o = e._rootScopes,
            ...
            a = [...t, ...o],
            r = new Set;
        i in t[0] || r.add(t[0][i] = {}), r.add(n);
        let l = tn(r, a, i, s || i);
        return null !== l && ((!ht(s) || s === i || (l = tn(r, a, s, l), null !== l)) && $i([...r], [""], o, s))
    }
    ...
    function rn(t) {
        ...
        function (t, e, i) {
            const n = t.length;
            let o, s, a, r, l, c = sn(t, 0);
            for (let h = 0; h < n - 1; ++h) l = c, c = sn(t, h + 1), l && c && (Ot(e[h], 0, on) ? i[h] = i[h + 1] = 0 : (o = i[h] / e[h], s = i[h + 1] / e[h], r = Math.pow(o, 2) + Math.pow(s, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[h] = o * a * e[h], i[h + 1] = s * a * e[h])))
        }(t, i, n),
        function (t, e) {
            const i = t.length;
            let n, o, s, a = sn(t, 0);
    ...
    function cn(t, e, i, n) {
        let o, s, a, r;
        if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) rn(t);
        else {
            let i = n ? t[t.length - 1] : t[0];
            for (o = 0, s = t.length; o < s; ++o) a = t[o], r = an(i, a, t[Math.min(o + 1, s - (n ? 0 : 1)) % s], e.tension), a.cp1x = r.previous.x, a.cp1y = r.previous.y, a.cp2x = r.next.x, a.cp2y = r.next.y, i = a
        }
        e.capBezierPoints && function (t, e) {
            let i, n, o, s, a, r = Kt(t[0], e);
            for (i = 0, n = t.length; i < n; ++i) a = s, s = r, r = i < n - 1 && Kt(t[i + 1], e), s && (o = t[i], a && (o.cp1x = ln(o.cp1x, e.left, e.right), o.cp1y = ln(o.cp1y, e.top, e.bottom)), r && (o.cp2x = ln(o.cp2x, e.left, e.right), o.cp2y = ln(o.cp2y, e.top, e.bottom)))
        }(t, i)
    }
    ...
    function bn(t, e, i) {
        ...
        const _ = () => x || l(o, m, g) && 0 !== r(o, m),
            y = () => !x || 0 === r(s, g) || l(s, m, g);
        for (let t = h, i = h; t <= d; ++t) p = e[t % a], p.skip || (g = c(p[n]), x = l(g, o, s), null === b && _() && (b = 0 === r(g, o) ? t : i), null !== b && y() && (f.push(xn(b, t, u, a)), b = null), i = t, m = g);
    ...
    var wn = new class {
        constructor() {
            this.controllers = new Mn(Ai, "datasets", !0), this.elements = new Mn(Oi, "elements"), this.plugins = new Mn(Object, "plugins"), this.scales = new Mn(ji, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
        }
        add(...t) {
    ...
    class kn {
        ...
        notify(t, e, i) {
            ...
            const o = n._descriptors(t),
                s = n._notify(o, t, e, i);
            return "destroy" === e && (n._notify(o, t, "stop"), n._notify(n._init, t, "uninstall")), s
        }
        _notify(t, e, i, n) {
            n = n || {};
            for (const o of t) {
    ...
    class En {
        constructor(t) {
            this._config = function (t) {
                ...
                return e.datasets = e.datasets || [], e.labels = e.labels || [], An(t), t
        ...
        getOptionScopes(t, e, i) {
            ...
            const r = new Set;
            e.forEach((e => {
                t && (r.add(t), e.forEach((e => Rn(r, t, e)))), e.forEach((t => Rn(r, n, t))), e.forEach((t => Rn(r, ut[o] || {}, t))), e.forEach((t => Rn(r, mt, t))), e.forEach((t => Rn(r, ft, t)))
            }));
            const l = [...r];
    ...
    function Nn(t) {
        return Hn() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t
    }
    const jn = {},
        $n = t => {
            const e = Nn(t);
    ...
    class Yn {
        constructor(t, e) {
            ...
            const l = n.platform.acquireContext(o, r.aspectRatio),
                ...
                h = c && c.height,
                d = c && c.width;
            this.id = j(), this.ctx = l, this.canvas = c, this.width = d, this.height = h, this._options = r, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._sortedMetasets = [], this.scales = {}, this.scale = void 0, this._plugins = new kn, this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = i((() => this.update("resize")), r.resizeDelay || 0), jn[n.id] = n, l && c ? (a.listen(n, "complete", Bn), a.listen(n, "progress", Wn), n._initialize(), n.attached && n.update()) : console.error("Failed to create chart: can't acquire context from the given item")
        }
        get aspectRatio() {
            const {
                options: {
        ...
        _initialize() {
            const t = this;
            return t.notifyPlugins("beforeInit"), t.options.responsive ? t.resize() : be(t, t.options.devicePixelRatio), t.bindEvents(), t.notifyPlugins("afterInit"), t
        }
        ...
        _resize(t, e) {
            ...
            i.width === a.width && i.height === a.height && r === l || (i.width = a.width, i.height = a.height, i._aspectRatio = i.aspectRatio, be(i, l, !0), i.notifyPlugins("resize", {
                size: a
        ...
        buildOrUpdateControllers() {
            ...
            for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
                ...
                if (s.type && s.type !== a && (t._destroyDatasetMeta(n), s = t.getDatasetMeta(n)), s.type = a, s.indexAxis = o.indexAxis || Dn(a, t.options), s.order = o.order || 0, t._updateMetasetIndex(s, n), s.label = "" + o.label, s.visible = t.isDatasetVisible(n), s.controller) s.controller.updateIndex(n), s.controller.linkScales();
                else {
        ...
        update(t) {
            ...
            for (let t = 0, i = e.data.datasets.length; t < i; t++) {
                const {
                    controller: i
                } = e.getDatasetMeta(t), a = !n && -1 === o.indexOf(i);
            ...
            e._minPadding = s, e._updateLayout(s), n || J(o, (t => {
                ...
                mode: t
            }), e._layers.sort(Vn("z", "_idx")), e._lastEvent && e._eventHandler(e._lastEvent, !0), e.render()
        }
        _updateLayout(t) {
            const e = this;
        ...
        render() {
            ...
            !1 !== t.notifyPlugins("beforeRender", {
                cancelable: !0
            }) && (a.has(t) ? t.attached && !a.running(t) && a.start(t) : (t.draw(), Bn({
                chart: t
            })))
        }
        draw() {
        ...
        destroy() {
            ...
            t.config.clearCache(), e && (t.unbindEvents(), Xt(e, i), t.platform.releaseContext(i), t.canvas = null, t.ctx = null), t.notifyPlugins("destroy"), delete jn[t.id]
        }
        toBase64Image(...t) {
        ...
        _eventHandler(t, e) {
            ...
            return n.cancelable = !1, i.notifyPlugins("afterEvent", n), (o || n.changed) && i.render(), i
        }
        _handleEvent(t, e) {
            const i = this,
                {
            ...
            let r = [],
                l = !1,
                c = null;
            return "mouseout" !== t.type && (r = i.getElementsAtEventForMode(t, s.mode, s, a), c = "click" === t.type ? i._lastEvent : t), i._lastEvent = null, Q(o.onHover, [t, r, i], i), "mouseup" !== t.type && "click" !== t.type && "contextmenu" !== t.type || Kt(t, i.chartArea, i._minPadding) && Q(o.onClick, [t, r, i], i), l = !tt(r, n), (l || e) && (i._active = r, i._updateHoverStyles(r, n, e)), i._lastEvent = c, l
        }
    }
    ...
    function Jn(t, e, i, n) {
        const o = t.iScale,
            ...
            l = [];
        let c, h, d, u;
        for (c = i, h = i + n; c < h; ++c) u = e[c], d = {}, d[o.axis] = r || o.parse(a[c], c), l.push(Qn(u, d, s, c));
        return l
    }
    ...
    class eo extends Ai {
        ...
        parseObjectData(t, e, i, n) {
            ...
            let d, u, f, g;
            for (d = i, u = i + n; d < u; ++d) g = e[d], f = {}, f[o.axis] = o.parse(lt(g, l), d), h.push(Qn(lt(g, c), f, s, d));
            return h
        }
        updateRangeFromParsed(t, e, i, n) {
        ...
        getLabelAndValue(t) {
            const e = this._cachedMeta,
                ...
                o = this.getParsed(t),
                s = o._custom,
                a = to(s) ? "[" + s.start + ", " + s.end + "]" : "" + n.getLabelForValue(o[n.axis]);
            return {
        ...
        updateElements(t, e, i, n) {
            ...
            for (let a = e; a < e + i; a++) {
                ...
                u && (h.options = d || o.resolveDataElementOptions(a, n)), o.updateElement(t[a], a, h, n)
            }
        }
        _getStacks(t, e) {
    ...
    class io extends Ai {
        ...
        updateElements(t, e, i, n) {
            ...
            for (let l = e; l < e + i; l++) {
                const e = t[l],
                    i = !s && o.getParsed(l),
                    c = s ? a.getPixelForDecimal(.5) : a.getPixelForValue(i.x),
                ...
                } = e._getRotationExtents(),
                {
                    ...
                    if (e < bt) {
                        const r = t,
                            ...
                            g = (t, e, n) => Wt(t, r, l) ? -1 : Math.min(e, e * i, n, n * i),
                            p = f(0, c, d),
                            m = f(Mt, h, u),
                            x = g(xt, c, d),
                            b = g(xt + Mt, h, u);
        ...
        update(t) {
            ...
            let {
                ...
                if (t._sorted) {
                    ...
                    d && (o = Ht(Math.min(ie(r, a.axis, c).lo, i ? n : ie(e, l, a.getPixelForValue(c)).lo), 0, n - 1)), s = u ? Ht(Math.max(ie(r, a.axis, h).hi + 1, i ? 0 : ie(e, l, a.getPixelForValue(h)).hi + 1), o, n) - o : n - o
                }
                return {
                    start: o,
                    count: s
            ...
            if (e._drawStart = r, e._drawCount = l, function (t) {
                    const {
                        xScale: e,
                        yScale: i,
                        _scaleRanges: n
                ...
                }(i) && (r = 0, l = o.length), n._decimated = !!s._decimated, n.points = o, "resize" !== t) {
                const i = e.resolveDatasetElementOptions(t);
                e.options.showLine || (i.borderWidth = 0), e.updateElement(n, void 0, {
                    animated: !a,
                    options: i
                }, t)
            }
        ...
        updateElements(t, e, i, n) {
            ...
            for (let c = e; c < e + i; ++c) {
                const e = t[c],
                    ...
                    x = u.y = s ? r.getBasePixel() : r.getPixelForValue(l ? o.applyStack(r, i, l) : i.y, c);
                u.skip = isNaN(m) || isNaN(x), u.stop = c > 0 && i.x - p.x > f, d && (u.options = h || o.resolveDataElementOptions(c, n)), g || o.updateElement(e, c, u, n), p = i
            }
    ...
    function ho(t, e) {
        ...
        let c = o / r;
        t.beginPath(), t.arc(s, a, r, i - c, n + c), l > o ? (c = o / l, t.arc(s, a, l, n + c, i - c, !0)) : t.arc(s, a, o, n + Mt, i - Mt), t.closePath(), t.clip()
    }
    ...
    function uo(t, e) {
        const {
            ...
            endAngle: s,
            pixelMargin: a
        } = e, r = Math.max(e.outerRadius - a, 0), l = e.innerRadius + a;
        t.beginPath(), t.arc(i, n, r, o, s), t.arc(i, n, l, s, o, !0), t.closePath()
    }
    ...
    function fo(t, e) {
        const {
            ...
            pixelMargin: a,
            options: r
        } = e, l = e.outerRadius, c = e.innerRadius + a, h = "inner" === r.borderAlign;
        r.borderWidth && (h ? (t.lineWidth = 2 * r.borderWidth, t.lineJoin = "round") : (t.lineWidth = r.borderWidth, t.lineJoin = "bevel"), e.fullCircles && function (t, e, i) {
            const {
                x: n,
                y: o,
                startAngle: s,
                endAngle: a,
                pixelMargin: r
            } = e, l = Math.max(e.outerRadius - r, 0), c = e.innerRadius + r;
            let h;
            for (i && (e.endAngle = e.startAngle + bt, ho(t, e), e.endAngle = a, e.endAngle === e.startAngle && (e.endAngle += bt, e.fullCircles--)), t.beginPath(), t.arc(n, o, c, s + bt, s, !0), h = 0; h < e.fullCircles; ++h) t.stroke();
            for (t.beginPath(), t.arc(n, o, l, s, s + bt), h = 0; h < e.fullCircles; ++h) t.stroke()
        }(t, e, h), h && ho(t, e), t.beginPath(), t.arc(i, n, l, o, s), t.arc(i, n, c, s, o, !0), t.closePath(), t.stroke())
    }
    class go extends Oi {
        constructor(t) {
        ...
        getCenterPoint(t) {
            const {
                ...
                innerRadius: s,
                outerRadius: a
            } = this.getProps(["x", "y", "startAngle", "endAngle", "innerRadius", "outerRadius"], t), r = (n + o) / 2, l = (s + a) / 2;
            return {
                x: e + Math.cos(r) * l,
                y: i + Math.sin(r) * l
            }
            ...
            if (e.pixelMargin = "inner" === i.borderAlign ? .33 : 0, e.fullCircles = Math.floor(e.circumference / bt), !(0 === e.circumference || e.innerRadius < 0 || e.outerRadius < 0)) {
                ...
                t.fillStyle = i.backgroundColor, t.strokeStyle = i.borderColor,
                    function (t, e) {
                        ...
                        isNaN(e.circumference) || (e.endAngle = e.startAngle + e.circumference % bt), uo(t, e), t.fill()
                    }(t, e), fo(t, e), t.restore()
            }
        }
    }
    ...
    const yo = "function" == typeof Path2D ? function (t, e, i, n) {
        let o = e._path;
        o || (o = e._path = new Path2D, e.path(o, i, n) && o.closePath()), t.stroke(o)
    } : function (t, e, i, n) {
    ...
    class vo extends Oi {
        ...
        draw(t, e, i, n) {
            const o = this,
                s = o.options || {};
            (o.points || []).length && s.borderWidth && (t.save(), function (t, e) {
                t.lineCap = e.borderCapStyle, t.setLineDash(e.borderDash), t.lineDashOffset = e.borderDashOffset, t.lineJoin = e.borderJoinStyle, t.lineWidth = e.borderWidth, t.strokeStyle = e.borderColor
            }(t, s), yo(t, o, i, n), t.restore(), o.animated && (o._pointsUpdated = !1, o._path = void 0))
        }
    }
    ...
    class wo extends Oi {
        constructor(t) {
            super(), this.options = void 0, this.skip = void 0, this.stop = void 0, t && Object.assign(this, t)
        }
        inRange(t, e, i) {
    ...
    function So(t) {
        ...
        const i = {};
        return e ? (e = t.horizontal ? Po(e, "left", "right", t.base > t.x) : Po(e, "bottom", "top", t.base < t.y), i[e] = !0, i) : i
    }

    function Po(t, e, i, n) {
        var o, s, a;
        return n ? (a = i, t = Do(t = (o = t) === (s = e) ? a : o === a ? s : o, i, e)) : t = Do(t, e, i), t
    }
    ...
    class Ro extends Oi {
        ...
        draw(t) {
            const e = this.options,
                ...
                o = (s = n.radius).topLeft || s.topRight || s.bottomLeft || s.bottomRight ? To : Lo;
            var s;
                    ...
                    case "lttb":
                        h = function (t, e, i) {
                            ...
                            for (o[d++] = t[u], a = 0; a < n - 2; a++) {
                                ...
                                for (l = c = -1, e = m; e < x; e++) c = .5 * Math.abs((b - i) * (t[e].y - _) - (b - t[e].x) * (n - _)), c > l && (l = c, r = t[e], h = e);
                                o[d++] = r, u = h
                            }
                    ...
                    case "min-max":
                        h = function (t, e) {
                            ...
                            for (i = 0; i < t.length; ++i) {
                                ...
                                const x = 0 | o;
                                if (x === a) s < h ? (h = s, r = i) : s > d && (d = s, l = i), u = (f * u + n.x) / ++f;
                                else {
                                    const e = i - 1;
                                    if (!$(r) && !$(l)) {
                                    ...
                                    i > 0 && e !== c && g.push(t[e]), g.push(n), a = x, f = 0, h = d = s, r = l = c = i
                                }
                            }
                            return g
                        }(l, n);
    ...
    const Wo = t => "line" === t.type && !t.hidden;
    ...
    function Go(t, e) {
        const {
            ...
            for (let t = 0; t < n.length; t++) {
                const r = n[t],
                    l = Uo(i, o[r.start], o[r.end], r.loop);
                if (!e.segments) {
                    a.push({
                        source: r,
                        target: l,
                ...
                for (let t = 0; t < c.length; ++t) {
                    const e = c[t],
                        n = Uo(i, s[e.start], s[e.end], e.loop),
                        h = bn(r, o, n);
                    for (let t = 0; t < h.length; t++) a.push({
                        source: h[t],
                        target: e,
                        start: {
                            [i]: Xo(l, n, "start", Math.max)
                        },
                        end: {
                            [i]: Xo(l, n, "end", Math.min)
                        }
                    })
                }
            }
        ...
        for (let e = 0, s = r.length; e < s; ++e) {
            ...
            t.save(), qo(t, a, Uo(o, c, h)), t.beginPath();
            const d = !!i.pathSegment(t, s);
            d ? t.closePath() : Ko(t, n, h, o);
            const u = !!n.pathSegment(t, l, {
                    move: d,
                    reverse: !0
                }),
                f = d && u;
            f || Ko(t, n, c, o), t.closePath(), t.fill(f ? "evenodd" : "nonzero"), t.restore()
        }
    }
    var Zo = {
        id: "filler",
        afterDatasetsUpdate(t, e, i) {
            const n = (t.data.datasets || []).length,
                ...
                s = [];
            let a, r, l, c;
            for (r = 0; r < n; ++r) a = t.getDatasetMeta(r), l = a.dataset, c = null, l && l.options && l instanceof vo && (c = {
            ...
            for (r = 0; r < n; ++r) c = s[r], c && !1 !== c.fill && (c.fill = $o(s, r, o))
        },
        beforeDatasetsDraw(t) {
            const e = t.getSortedVisibleDatasetMetas(),
                i = t.chartArea;
            let n, o;
            for (n = e.length - 1; n >= 0; --n) o = e[n].$filler, o && o.line.updateControlPoints(i)
        },
        beforeDatasetDraw(t, e) {
            ...
            const s = function (t) {
                    ...
                    if ("stack" === i) return Bo(t);
                    const o = Vo(t);
                    return o instanceof zo ? o : jo(o, n)
                }(o),
                {
                    line: a,
                    scale: r
            ...
            s && a.points.length && (Gt(n, i), function (t, e) {
                const {
                    line: i,
                    target: n,
                    above: o,
                ...
                t.save(), "x" === l && s !== o && (Yo(t, n, a.top), Go(t, {
                    line: i,
                    target: n,
                    color: o,
                    scale: r,
                    property: l
                }), t.restore(), t.save(), Yo(t, n, a.bottom)), Go(t, {
                    line: i,
                    target: n,
                    color: s,
                    scale: r,
    ...
    class Jo extends Oi {
        ...
        _draw() {
            const t = this,
                ...
                p = g / 2;
            let m;
            t.drawTitle(), a.textAlign = h.textAlign("left"), a.textBaseline = "middle", a.lineWidth = .5, a.strokeStyle = u, a.fillStyle = u, a.font = d.string;
            const {
                boxWidth: x,
                boxHeight: b,
                itemHeight: _
            } = Qo(l, g), y = t.isHorizontal(), v = this._computeTitleHeight();
            m = y ? {
            ...
            t.legendItems.forEach(((e, u) => {
                ...
                let P = m.x,
                    D = m.y;
                h.setWidth(t.width), y ? u > 0 && P + S + f > t.right && (D = m.y += M, m.line++, P = m.x = o(r, t.left + f, t.right - n[m.line])) : u > 0 && D + M > t.bottom && (P = m.x = P + i[m.line].width + f, m.line++, D = m.y = o(r, t.top + v + f, t.bottom - i[m.line].height));
                ! function (t, e, i) {
                    ...
                    if (a.fillStyle = K(i.fillStyle, c), a.lineCap = K(i.lineCap, "butt"), a.lineDashOffset = K(i.lineDashOffset, 0), a.lineJoin = K(i.lineJoin, "miter"), a.lineWidth = n, a.strokeStyle = K(i.strokeStyle, c), a.setLineDash(K(i.lineDash, [])), l.usePointStyle) {
                        ...
                        a.fillRect(h.leftForLtr(t, x), i, x, b), 0 !== n && a.strokeRect(h.leftForLtr(t, x), i, x, b)
                    }
                    a.restore()
                }(h.x(P), D, e), P = s(k, P + x + p, t.right),
                    function (t, e, i) {
                        te(a, i.text, t, e + _ / 2, d, {
                            strikethrough: i.hidden,
                            textAlign: i.textAlign
                        })
                    }(h.x(P), D, e), y ? m.x += S + f : m.y += M
    ...
    class gs extends Oi {
        ...
        getBody(t, e) {
            ...
            return J(t, (t => {
                const e = {
                    ...
                    s = fs(n, t);
                os(e.before, ss(s.beforeLabel.call(i, t))), os(e.lines, s.label.call(i, t)), os(e.after, ss(s.afterLabel.call(i, t))), o.push(e)
            })), o
        }
        getAfterBody(t, e) {
        ...
        drawTitle(t, e, i) {
            ...
            if (s) {
                ...
                for (t.x = ds(n, i.titleAlign, i), e.textAlign = c.textAlign(i.titleAlign), e.textBaseline = "middle", a = Ee(i.titleFont), r = i.titleSpacing, e.fillStyle = i.titleColor, e.font = a.string, l = 0; l < s; ++l) e.fillText(o[l], c.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + r, l + 1 === s && (t.y += i.titleMarginBottom - r)
            }
        }
        ...
        drawBody(t, e, i) {
            ...
            const f = fn(i.rtl, n.x, n.width),
                ...
                p = f.textAlign(a);
            let m, x, b, _, y, v, M;
            for (e.textAlign = a, e.textBaseline = "middle", e.font = h.string, t.x = ds(n, p, i), e.fillStyle = i.bodyColor, J(n.beforeBody, g), u = r && "right" !== p ? "center" === a ? c / 2 + 1 : c + 2 : 0, _ = 0, v = o.length; _ < v; ++_) {
                for (m = o[_], x = n.labelTextColors[_], e.fillStyle = x, J(m.before, g), b = m.lines, r && b.length && (n._drawColorBox(e, t, _, f, i), d = Math.max(h.lineHeight, l)), y = 0, M = b.length; y < M; ++y) g(b[y]), d = h.lineHeight;
                J(m.after, g)
            }
        ...
        drawFooter(t, e, i) {
            ...
            if (s) {
                ...
                for (t.x = ds(n, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = l.textAlign(i.footerAlign), e.textBaseline = "middle", a = Ee(i.footerFont), e.fillStyle = i.footerColor, e.font = a.string, r = 0; r < s; ++r) e.fillText(o[r], l.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + i.footerSpacing
            }
        }
        ...
        draw(t) {
            ...
            i.enabled && r && (t.save(), t.globalAlpha = n, e.drawBackground(s, t, o, i), gn(t, i.textDirection), s.y += a.top, e.drawTitle(s, t, i), e.drawBody(s, t, i), e.drawFooter(s, t, i), pn(t, i.textDirection), t.restore())
        }
        getActiveElements() {
            return this._active || []
        }
        ...
        _positionChanged(t, e) {
            const i = this,
                n = ns[i.options.position].call(i, t, e);
    ...
    class bs extends ji {
        ...
        parse(t, e) {
            ...
            return ((t, e) => null === t ? null : Ht(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : xs(i, t, K(e, t)), i.length - 1)
        }
        determineDataLimits() {
            const t = this,
                {
    ...
    bs.id = "category", bs.defaults = {
        ticks: {
            callback: bs.prototype.getLabelForValue
        }
    };
    class _s extends ji {
        constructor(t) {
        ...
        buildTicks() {
            ...
            const o = function (t, e) {
                ...
                if (y < 1e-14 && !f && !g) return [{
                    value: d
                }, {
                    value: u
                }];
                _ = Math.ceil(u / y) - Math.floor(d / y), _ > h && (y = Dt(_ * y / h / c) * c), $(a) || (m = Math.pow(10, a), y = Math.ceil(y * m) / m), x = Math.floor(d / y) * y, b = Math.ceil(u / y) * y, f && g && n && Tt((s - o) / n, y / 1e3) ? (_ = Math.min((s - o) / y, l), y = (s - o) / _, x = o, b = s) : p ? (x = f ? o : x, b = g ? s : b, _ = r - 1, y = (b - x) / _) : (_ = (b - x) / y, _ = Ot(_, Math.round(_), y / 1e3) ? Math.round(_) : Math.ceil(_)), m = Math.pow(10, $(a) ? It(y) : a), x = Math.round(x * m) / m, b = Math.round(b * m) / m;
                let v = 0;
                for (f && (i.push({
                        value: o
                    }), x < o && v++, Tt(Math.round((x + v * y) * m) / m / o, y / 1e3) && v++); v < _; ++v) i.push({
                    value: Math.round((x + v * y) * m) / m
                });
                return g ? Tt(i[i.length - 1].value / s, y / 1e3) ? i[i.length - 1].value = s : i.push({
                    value: s
                }) : i.push({
                    value: b
                }), i
            ...
            return "ticks" === e.bounds && Lt(o, t, "value"), e.reverse ? (o.reverse(), t.start = t.max, t.end = t.min) : (t.start = t.min, t.end = t.max), o
        }
        configure() {
            const t = this,
                e = t.ticks;
    ...
    class Ms extends ji {
        ...
        parse(t, e) {
            const i = _s.prototype.parse.apply(this, [t, e]);
        ...
        buildTicks() {
            ...
            return "ticks" === e.bounds && Lt(i, t, "value"), e.reverse ? (i.reverse(), t.start = t.max, t.end = t.min) : (t.start = t.min, t.end = t.max), i
        }
        getLabelForValue(t) {
        ...
        getPixelForValue(t) {
            const e = this;
            return void 0 !== t && 0 !== t || (t = e.min), e.getPixelForDecimal(t === e.min ? 0 : (St(t) - e._startValue) / e._valueRange)
        }
        getValueForPixel(t) {
            const e = this,
    ...
    class As extends _s {
        ...
        setDimensions() {
            const t = this;
            t.width = t.maxWidth, t.height = t.maxHeight, t.paddingTop = ws(t.options) / 2, t.xCenter = Math.floor(t.width / 2), t.yCenter = Math.floor((t.height - t.paddingTop) / 2), t.drawingArea = Math.min(t.height - t.paddingTop, t.width) / 2
        }
        determineDataLimits() {
            const t = this,
                {
        ...
        generateTickLabels(t) {
            const e = this;
            _s.prototype.generateTickLabels.call(e, t), e._pointLabels = e.getLabels().map(((t, i) => {
            ...
            e.display && e.pointLabels.display ? function (t) {
                ...
                for (n = 0; n < l; n++) {
                    ...
                    const f = t.getIndexAngle(n),
                        g = Et(f),
                        p = ks(g, s.x, o.w, 0, 180),
                        m = ks(g, s.y, o.h, 90, 270);
        ...
        _setReductions(t, e, i) {
            ...
            o = Cs(o), s = Cs(s), a = Cs(a), r = Cs(r), n.drawingArea = Math.max(t / 2, Math.min(Math.floor(t - (o + s) / 2), Math.floor(t - (a + r) / 2))), n.setCenterPoint(o, s, a, r)
        }
        ...
        drawBackground() {
            ...
            if (e) {
                const n = t.ctx;
                n.save(), n.beginPath(), Ds(t, t.getDistanceFromCenterForValue(t._endValue), i, t.getLabels().length), n.closePath(), n.fillStyle = e, n.fill(), n.restore()
            }
        }
        drawGrid() {
            const t = this,
            ...
            if (i.pointLabels.display && function (t, e) {
                    ...
                    if (0 !== i) {
                        ...
                        ! function (t, e, i, n) {
                            ...
                            !s && !n || !a || !r || i < 0 || (o.save(), o.strokeStyle = a, o.lineWidth = r, o.setLineDash(e.borderDash), o.lineDashOffset = e.borderDashOffset, o.beginPath(), Ds(t, i, s, n), o.closePath(), o.stroke(), o.restore())
                        }(t, n, r, s)
                    }
                })), n.display) {
    ...
    function Rs(t, e) {
        ...
        let r = e;
        return "function" == typeof o && (r = o(r)), X(r) || (r = "string" == typeof o ? i.parse(r, o) : i.parse(r)), null === r ? null : (s && (r = "week" !== s || !At(a) && !0 !== a ? i.startOf(r, s) : i.startOf(r, "isoWeek", a)), +r)
    }

    function Es(t, e, i, n) {
        const o = Ts.length;
        for (let s = Ts.indexOf(t); s < o - 1; ++s) {
            const t = Os[Ts[s]],
                o = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
            if (t.common && Math.ceil((i - e) / (o * t.size)) <= n) return Ts[s]
        }
        return Ts[o - 1]
    }
    ...
    class zs extends ji {
        ...
        buildTicks() {
            ...
            const s = t.min,
                a = oe(o, s, t.max);
            return t._unit = i.unit || (n.autoSkip ? Es(i.minUnit, t.min, t.max, t._getLabelCapacity(s)) : function (t, e, i, n, o) {
                for (let s = Ts.length - 1; s >= Ts.indexOf(i); s--) {
                    const i = Ts[s];
                    if (Os[i].common && t._adapter.diff(o, n, i) >= e - 1) return i
                }
                ...
                for (let e = Ts.indexOf(t) + 1, i = Ts.length; e < i; ++e)
                    if (Os[Ts[e]].common) return Ts[e]
            }(t._unit) : void 0, t.initOffsets(o), e.reverse && a.reverse(), Fs(t, a, t._majorUnit)
        }
        initOffsets(t) {
            const e = this;
            let i, n, o = 0,
        ...
        _generate() {
            const t = this,
                ...
                o = t.options,
                s = o.time,
                a = s.unit || Es(s.minUnit, i, n, t._getLabelCapacity(i)),
                r = K(s.stepSize, 1),
            ...
            for (d = f, u = 0; d < n; d = +e.add(d, r, a), u++) Is(h, d, g);
            return d !== n && "ticks" !== o.bounds && 1 !== u || Is(h, d, g), Object.keys(h).sort(((t, e) => t - e)).map((t => +t))
        }
        getLabelForValue(t) {
        ...
        _getLabelCapacity(t) {
            const e = this,
                ...
                s = e._tickFormatFunction(t, 0, Fs(e, [t], e._majorUnit), o),
                a = e._getLabelSize(s),
    ...
    class Bs extends zs {
        ...
        getDecimalForValue(t) {
            return Vs(this._table, t) / this._maxIndex
        }
        getValueForPixel(t) {
            const e = this,
                i = e._offsets,
                n = e.getDecimalForPixel(t) / i.factor - i.end;
            return Vs(e._table, n * this._maxIndex, !0)
        }
    }
    Bs.id = "timeseries", Bs.defaults = zs.defaults;
    ...
    return Yn.register(co, Ws, Eo, ms), Yn.helpers = {
        ...vn
