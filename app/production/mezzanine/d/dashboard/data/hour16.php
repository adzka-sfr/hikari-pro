...
// mid
$mid116p = mysqli_query($con_pro, "SELECT SUM(qty) as total from ongoing_slip where  time_out >= '$day3' and time_out <= '$now'  and kategori = 'PANEL'");
...
$midr16p = mysqli_query($con_pro, "SELECT count(distinct slip) as total from ongoing_slip where  time_out >= '$day3' and time_out <= '$now'  and kategori = 'PANEL'");
...
// more
$more116p = mysqli_query($con_pro, "SELECT SUM(qty) as total from ongoing_slip where  time_out < '$day3' and kategori = 'PANEL'");
...
$morer16p = mysqli_query($con_pro, "SELECT count(distinct slip) as total from ongoing_slip where  time_out < '$day3' and kategori = 'PANEL'");
...
// mid
$mid116ss = mysqli_query($con_pro, "SELECT SUM(qty) as total from ongoing_slip where  time_out >= '$day3' and time_out <= '$now'  and kategori = 'SMALL SHORT'");
...
$midr16ss = mysqli_query($con_pro, "SELECT count(distinct slip) as total from ongoing_slip where  time_out >= '$day3' and time_out <= '$now'  and kategori = 'SMALL SHORT'");
...
// more
$more116ss = mysqli_query($con_pro, "SELECT SUM(qty) as total from ongoing_slip where  time_out < '$day3' and kategori = 'SMALL SHORT'");
...
$morer16ss = mysqli_query($con_pro, "SELECT count(distinct slip) as total from ongoing_slip where  time_out < '$day3' and kategori = 'SMALL SHORT'");
...
// mid
$mid116sl = mysqli_query($con_pro, "SELECT SUM(qty) as total from ongoing_slip where  time_out >= '$day3' and time_out <= '$now'  and kategori = 'SMALL LONG'");
...
$midr16sl = mysqli_query($con_pro, "SELECT count(distinct slip) as total from ongoing_slip where  time_out >= '$day3' and time_out <= '$now'  and kategori = 'SMALL LONG'");
...
// more
$more116sl = mysqli_query($con_pro, "SELECT SUM(qty) as total from ongoing_slip where  time_out < '$day3' and kategori = 'SMALL LONG'");
...
$morer16sl = mysqli_query($con_pro, "SELECT count(distinct slip) as total from ongoing_slip where  time_out < '$day3' and kategori = 'SMALL LONG'");
