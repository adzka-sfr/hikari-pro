...
$cek = mysqli_query($connect, "SELECT c_status, c_name, c_dir, c_group from t_app where c_dir = 'mezzanine'");
...
if ($data['c_status'] == 'develop') {
    ...
    echo "<script>window.location='" . base_url('app/' . $data['c_group'] . '/' . $data['c_dir'] . '/dashboard/index.html') . "';</script>";
}
