    ...
    <body class="nav-md">
        <div class="container body">
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                <ul class="nav side-menu">
                                    <li class="dashboard"><a href="../dashboard/"><i class="fa fa-desktop"></i> Dashboard</a></li>
                                    <li class="dashboard"><a href="../safety_stock/"><i class="fa fa-pencil"></i> Adjust Safety Stock</a></li>
            ...
            <div class="right_col" role="main">
                ...
                <script src="<?= base_url('_assets/src/add/realtime/jquery-3.5.1.js') ?>"></script>
