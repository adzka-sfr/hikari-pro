                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "dash") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=dash"><i class="fa fa-desktop"></i> Dashboard</a>
                                </li>
                            </ul>
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['page'] == "aust") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?page=aust"><i class="fa fa-cloud-upload"></i> Upload ST Master</a>
                                </li>
                            </ul>
                        </div>
