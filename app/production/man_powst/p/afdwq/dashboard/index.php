...
<div class="row">
    <div class="col-12">
        <select class="pilihwc" style="width: 100%;" id="workcenter">
            ...
            <?php
            $sql1 = mysqli_query($connect_pro, "SELECT DISTINCT c_workcenter FROM manpow_st ORDER BY c_workcenter ASC");

            while ($data1 = mysqli_fetch_array($sql1)) {
            ?>
                <option value="<?= $data1['c_workcenter'] ?>"><?= $data1['c_workcenter'] ?></option>
            <?php
            }
            ?>
        </select>
