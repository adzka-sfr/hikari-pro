...
<body class="nav-md footer_fixed" style="background-color: #F7F7F7;">
    ...
    <div class="right_col" role="main">
        ...
        <div class="dashboard_graph" style="padding-bottom: 0px;">
            <div class="row">
                <div class="col-md-9">
                    <h2 style="font-weight: bold; padding-left: 10px; margin-top: 0px; font-size: 23px; color: #212529;"><?= strtoupper($app_name) ?> - PRIORITY OF G150</h2>
                </div>
                <div class="col-md-3">
    ...
    <script>
        ...
        function update() {
            $.getJSON("G1.php", function(data) {
                $("#g150").empty();
                var no = 1;
                $.each(data.result, function() {
                    $("#g150").append("<tr><td style='text-align: center;'>" + (no++) + "</td><td>" + this['name_ori_cabinet'] + "</td><td style='text-align:center'>" + this['name_piano'] + "</td><td style='text-align: center'><h1 style='border-radius: 0.25rem; background-color: #F9C8A0; text-align: center;'>" + this['pcs_prioritas'] + "</h1></td></tr>");
                });
            });
        }
    </script>
