    ...
    <div class="separator">
                                ...
                                <div class="row">
                                    <div class="col-10">
                                        <select name="name_piano" style="border-radius: 0.25rem" required id="name_piano" class="form-select" aria-label="Default select example">
                                            ...
                                            ?>
                                            <option type="text">Select Piano</option>
                                            <?php
        ...
        <div class="row mb-2">
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        <h5 style="color: black; text-align: center; text-decoration: underline"> Destionation G0</h5>
                        <div style="overflow-y: scroll; height: 300px; display: block">
                            <table style="font-size : 16px; border-radius: 0.25rem; border: 1px solid #ddd" id="myTable" class="table table-responsive tableFixHead">
                                ...
                                <tbody>
                                    <?php
                                    $no = 0;
                                    $qty = mysqli_query($conn, "SELECT * FROM inventory WHERE destination = 'G2' ORDER BY qty desc");
            ...
            <div class="col-6 mb-2">
                <div class="card">
                    <div class="card-body">
                        <h5 style="color: black; text-align: center">Destionation G2</h5>
                        <div style="overflow-y: scroll; height: 300px; display: block">
                            <table style="font-size : 16px; border-radius: 0.25rem; border: 1px solid #ddd" id="myTable" class="table table-responsive tableFixHead">
                                <thead style="background-color: #f1f1f1; text-align: center">
                                    <tr>
                                ...
                                <tbody>
                                    <?php
                                    $no = 0;
                                    $qty = mysqli_query($conn, "SELECT * FROM inventory WHERE destination = 'G0' ORDER BY qty desc");
                                    while ($row = mysqli_fetch_array($qty)) {
                                        $no++;
                                        echo "
                                    <tr>
