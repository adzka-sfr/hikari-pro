        ...
        function update() {
            $.getJSON("G2.php", function(data) {
                ...
                $.each(data.result, function() {
                    $("table").append("<tr><td>" + (no++) + "</td><td>" + this['name_ori_cabinet'] + "</td><td style='text-align:left'>" + this['name_piano'] + "</td><td ><h1 style='border-radius: 0.25rem; background-color: #DEEDFF; text-align: center; margin-right: 20px '>" + this['pcs_prioritas'] + "</h1></td></tr>");
                });
            });
        }
    </script>
