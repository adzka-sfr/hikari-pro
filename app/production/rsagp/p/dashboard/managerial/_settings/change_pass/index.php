                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            <ul class="nav side-menu">
                                <li><a href="../../dashboard/dashboard.php"><i class="fa fa-desktop"></i> Ratio Set</a></li>
                                <li><a><i class="fa fa-edit"></i> Entry Data<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li class=""><a href="../../managerial//plan/plan.php"><i class="fa fa-calendar-plus-o"></i> Plan</a></li>
                                    </ul>
                                </li>
                                <li class=""><a href="../../managerial/priority/priority.php"><i class='fa fa-signal'></i> Priority</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                ...
                                <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="../../../../../../../auth/act_logout.php"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                                </div>
                            </li>
                        </ul>
                    </nav>
