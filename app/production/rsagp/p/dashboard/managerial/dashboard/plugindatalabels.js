...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : ((t = "undefined" != typeof globalThis ? globalThis : t || self).ChartDataLabels = e(t.Chart.helpers, t.Chart));
})(this, function (t, e) {
  "use strict";
  var r = (function () {
  ...
  function u(t, e) {
    ...
    return (
      ...
      "start" === o ? ((r = n.x0), (a = n.y0)) : "end" === o ? ((r = n.x1), (a = n.y1)) : ((r = (n.x0 + n.x1) / 2), (a = (n.y0 + n.y1) / 2)),
      (function (t, e, r, a, o) {
        switch (o) {
          case "center":
            r = a = 0;
  ...
  var d = function (t, e) {
    ...
    h = function (t, e) {
      var r = l(t, e.origin),
        ...
        i = 0;
      return (
        t.horizontal ? ((a = Math.min(t.x, t.base)), (n = Math.abs(t.base - t.x))) : ((o = Math.min(t.y, t.base)), (i = Math.abs(t.base - t.y))),
        u(
          {
            x0: a,
            y0: o + i,
    ...
    (a || (o && n)) &&
      ...
      (function (t, e, r, a, o, n) {
        ...
        if (n) {
          ...
          t.moveTo(e, u),
            s < d && u < c
              ? (t.arc(s, u, l, -Math.PI, -i), t.arc(d, u, l, -i, 0), t.arc(d, c, l, 0, i), t.arc(s, c, l, i, Math.PI))
              : s < d
  ...
  t.merge(_.prototype, {
    ...
    draw: function (t, e) {
      ...
      this.visible() &&
        (a.save(),
        o.clip && ((r = o.area), a.beginPath(), a.rect(r.left, r.top, r.right - r.left, r.bottom - r.top), a.clip()),
  ...
  function S(e, r, a) {
    if (r) {
      var o,
        n = a.$context,
        i = a.$groups;
      r[i._set] && (o = r[i._set][i._key]) && !0 === t.callback(o, [n]) && ((e.$datalabels._dirty = !0), a.update(n));
    }
  }
  ...
  function I(t, e) {
    ...
    if (n.enter || n.leave) {
      ...
      (r = o._hovered),
        ...
        (function (t, e, r, a) {
          var o, n;
          (r || a) && (r ? (a ? r !== a && (n = o = !0) : (n = !0)) : (o = !0), n && S(t, e.leave, r), o && S(t, e.enter, a));
        })(t, n, r, a);
    }
  }
  return {
      ...
      formatter: function (e) {
        ...
        if (t.isObject(e))
          if (t.isNullOrUndef(e.label))
            if (t.isNullOrUndef(e.r)) for (n = "", o = 0, a = (r = Object.keys(e)).length; o < a; ++o) n += (0 !== o ? ", " : "") + r[o] + ": " + e[r[o]];
            else n = e.r;
          else n = e.label;
        return "" + n;
      },
