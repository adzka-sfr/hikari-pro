...
! function (t, e) {
        ...
        if (!(isNaN(d) || d <= 0)) {
            switch (t.beginPath(), h) {
                default:
                    ...
                    break;
                case "triangle":
                    t.moveTo(i + Math.sin(u) * d, s - Math.cos(u) * d), u += St, t.lineTo(i + Math.sin(u) * d, s - Math.cos(u) * d), u += St, t.lineTo(i + Math.sin(u) * d, s - Math.cos(u) * d), t.closePath();
                    break;
                case "rectRounded":
                    l = .516 * d, r = d - l, o = Math.cos(u + kt) * r, a = Math.sin(u + kt) * r, t.arc(i - o, s - a, l, u - bt, u - Mt), t.arc(i + a, s - o, l, u - Mt, u), t.arc(i + o, s + a, l, u, u + Mt), t.arc(i - a, s + o, l, u + Mt, u + bt), t.closePath();
                    break;
                case "rect":
                    if (!c) {
                ...
                case "cross":
                    ...
                    break;
                case "star":
                    o = Math.cos(u) * d, a = Math.sin(u) * d, t.moveTo(i - o, s - a), t.lineTo(i + o, s + a), t.moveTo(i + a, s - o), t.lineTo(i - a, s + o), u += kt, o = Math.cos(u) * d, a = Math.sin(u) * d, t.moveTo(i - o, s - a), t.lineTo(i + o, s + a), t.moveTo(i + a, s - o), t.lineTo(i - a, s + o);
                    break;
                case "line":
    ...
    function ce(t, e) {
        ...
        if (!i) return;
        const s = i.listeners,
            n = s.indexOf(e); - 1 !== n && s.splice(n, 1), s.length > 0 || (le.forEach((e => {
            delete t[e]
        })), delete t._chartjs)
    }
    ...
    function _e(t, e) {
        ...
        } = e, n = pe(i), o = "border-box" === n.boxSizing, a = be(n, "padding"), r = be(n, "border", "width"), {
            x: l,
            y: h,
            box: c
        } = function (t, e) {
    ...
    function ve(t, e, i, s) {
        ...
        return h = Math.max(0, h - o.width), c = Math.max(0, s ? Math.floor(h / s) : c - o.height), h = ye(Math.min(h, a, l.maxWidth)), c = ye(Math.min(c, r, l.maxHeight)), h && !c && (c = ye(h / 2)), {
            width: h,
            height: c
        }
    }
    ...
    function Ce(t, e, i, s) {
        const n = [];
        if (!Gt(e, t.chartArea, t._minPadding)) return n;
        return De(t, i, e, (function (t, i, o) {
    ...
    function Ne(t, e, i) {
        const {
            min: s,
            max: n
        } = t, o = Z(e, (n - s) / 2), a = (t, e) => i && 0 === t ? 0 : t + e;
        return {
            min: a(s, -Math.abs(o)),
            max: a(n, o)
        }
    ...
    function Ye(t, e) {
        return t.filter((t => -1 === je.indexOf(t.pos) && t.box.axis === e))
    }
    ...
    var ei = {
        ...
        update(t, e, i, s) {
            ...
            Qe(r.fullSize, f, d, g), Qe(l, f, d, g), Qe(h, f, d, g) && Qe(l, f, d, g),
                ...
                }(f), ti(r.leftAndTop, f, d, g), f.x += f.w, f.y += f.h, ti(r.rightAndBottom, f, d, g), t.chartArea = {
                    left: f.left,
                    top: f.top,
                    right: f.left + f.w,
                    bottom: f.top + f.h,
    ...
    function si(t, e, i, s) {
        const n = {
            ...
            _stack: new Set,
            _descriptors: ni(t, s),
            setContext: e => si(t, e, i, s),
            override: n => si(t.override(n), e, i, s)
        };
        return new Proxy(n, {
    ...
    function _i(t, e = "x") {
        ...
        function (t, e, i) {
            const s = t.length;
            let n, o, a, r, l, h = mi(t, 0);
            for (let c = 0; c < s - 1; ++c) l = h, h = mi(t, c + 1), l && h && (Tt(e[c], 0, pi) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c], o = i[c + 1] / e[c], r = Math.pow(n, 2) + Math.pow(o, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[c] = n * a * e[c], i[c + 1] = o * a * e[c])))
        }(t, n, o),
        function (t, e, i = "x") {
            const s = xi(i),
                n = t.length;
    ...
    function vi(t, e, i, s, n) {
        ...
        if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) _i(t, n);
            ...
            for (o = 0, a = t.length; o < a; ++o) r = t[o], l = bi(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension), r.cp1x = l.previous.x, r.cp1y = l.previous.y, r.cp2x = l.next.x, r.cp2y = l.next.y, i = r
        }
        e.capBezierPoints && function (t, e) {
            let i, s, n, o, a, r = Gt(t[0], e);
            for (i = 0, s = t.length; i < s; ++i) a = o, o = r, r = i < s - 1 && Gt(t[i + 1], e), o && (n = t[i], a && (n.cp1x = yi(n.cp1x, e.left, e.right), n.cp1y = yi(n.cp1y, e.top, e.bottom)), r && (n.cp2x = yi(n.cp2x, e.left, e.right), n.cp2y = yi(n.cp2y, e.top, e.bottom)))
        }(t, i)
    }
    const wi = t => 0 === t || 1 === t,
        ...
        Si = {
            ...
            easeInOutElastic(t) {
                const e = .1125;
                return wi(t) ? t : t < .5 ? .5 * Mi(2 * t, e, .45) : .5 + .5 * ki(2 * t - 1, e, .45)
            },
            easeInBack(t) {
                const e = 1.70158;
                return t * t * ((e + 1) * t - e)
    ...
    function Ai(t, e, i) {
        return function (t, e) {
            ...
            let s = Oi.get(i);
            return s || (s = new Intl.NumberFormat(t, e), Oi.set(i, s)), s
        }(e, i).format(t)
    }
    ...
    function zi(t, e, i) {
        ...
        const y = () => b || l(n, x, p) && 0 !== r(n, x),
            v = () => !b || 0 === r(o, p) || l(o, x, p);
        for (let t = c, i = c; t <= d; ++t) m = e[t % a], m.skip || (p = h(m[s]), p !== x && (b = l(p, n, o), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(Ii({
            start: _,
            end: t,
            loop: u,
            count: a,
            ...
            for (const t of e) {
                ...
                for (u = d + 1; u <= t.end; u++) {
                    ...
                    e = Wi(s.setContext(He(n, {
                        ...
                        p1DataIndex: u % l,
                        datasetIndex: a
                    }))), Ni(e, c) && f(d, u - 1, t.loop, c), o = r, c = e
                }
    ...
    var Hi = Object.freeze({
        ...
        _bezierCurveTo: te,
        renderText: ee,
        addRoundedRectPath: se,
        _lookup: ne,
        _lookupByKey: oe,
        _rlookupByKey: ae,
        _filterBetween: re,
        listenArrayEvents: he,
        ...
        _descriptors: ni,
        splineCurve: bi,
        splineCurveMonotone: _i,
        _updateBezierControlPoints: vi,
        _isDomSupported: ue,
        _getParentNode: fe,
        getStyle: me,
        ...
        _int16Range: jt,
        getRtlAdapter: Ti,
        overrideTextDirection: Li,
        restoreTextDirection: Ri,
        _boundSegment: zi,
        _boundSegments: Fi,
        _computeSegments: Bi
    });
    ...
    function qi(t, e, i) {
        t.canvas.removeEventListener(e, i, Xi)
    }
    ...
    function ts(t, i, s) {
        ...
        return r.observe(o),
            function (t, e) {
                Zi.size || window.addEventListener("resize", Ji), Zi.set(t, e)
            }(t, a), r
    }

    function es(t, e, i) {
        i && i.disconnect(), "resize" === e && function (t) {
            Zi.delete(t), Zi.size || window.removeEventListener("resize", Ji)
        }(t)
    }
        ...
        acquireContext(t, e) {
            ...
            return i && i.canvas === t ? (function (t, e) {
                ...
                if (t.$chartjs = {
                    ...
                    }, i.display = i.display || "block", i.boxSizing = i.boxSizing || "border-box", Ui(n)) {
                    const e = ke(t, "width");
                    void 0 !== e && (t.width = e)
                }
                if (Ui(s))
    ...
    function ns(t) {
        return !ue() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? $i : ss
    }
    ...
    class ws {
        ...
        updateIndex(t) {
            this.index !== t && _s(this._cachedMeta), this.index = t
        }
        linkScales() {
            const t = this.chart,
                e = this._cachedMeta,
        ...
        includeOptions(t, e) {
            return !e || ys(t) || this.chart._animationsDisabled
        }
        updateElement(t, e, i, s) {
            ys(s) ? Object.assign(t, i) : this._resolveAnimations(e, s).update(t, i)
        }
        updateSharedOptions(t, e, i) {
            t && !ys(e) && this._resolveAnimations(void 0, e).update(t, i)
        }
        _setStyle(t, e, i, s) {
            t.active = s;
    ...
    const ks = {
        ...
        logarithmic(t, e, i) {
            ...
            return 1 === s || 2 === s || 5 === s ? ks.numeric.call(this, t, e, i) : ""
        }
    };
    var Ss = {
        formatters: ks
    ...
    function Ps(t, e) {
        ...
        if (o > 0) {
            ...
            for (Ds(e, l, h, $(s) ? 0 : a - s, a), t = 0, i = o - 1; t < i; t++) Ds(e, l, h, n[t], n[t + 1]);
            return Ds(e, l, h, r, $(s) ? e.length : r + s), l
        }
        return Ds(e, l, h), l
    }
    ...
    class Es extends Ms {
        ...
        generateTickLabels(t) {
            ...
            let i, s, n;
            for (i = 0, s = t.length; i < s; i++) n = t[i], n.label = Q(e.callback, [n.value, i, t], this)
        }
            ...
            if (o) {
                ...
                if (a ? (t.width = this.maxWidth, t.height = Ts(n) + o) : (t.height = this.maxHeight, t.width = Ts(n) + o), i.display && this.ticks.length) {
                    const {
                        ...
                        widest: n,
                        highest: o
                    } = this._getLabelSizes(), r = 2 * i.padding, l = Et(this.labelRotation), h = Math.cos(l), c = Math.sin(l);
                    if (a) {
        ...
        getPixelForDecimal(t) {
            ...
            return jt(this._alignToPixels ? Xt(this.chart, e, 0) : e)
        }
        ...
        getContext(t) {
            ...
            return this.$context || (this.$context = He(this.chart.getContext(), {
                scale: this,
                type: "scale"
            }))
        }
        ...
        _computeGridLineItems(t) {
            ...
            for (m = 0; m < l; m += C) {
                ...
                x = As(this, m, a), void 0 !== x && (b = Xt(i, x, e), r ? _ = v = M = S = b : y = w = k = P = b, c.push({
                    tx1: _,
                    ty1: y,
                    tx2: v,
                    ty2: w,
    ...
    var zs = new class {
        constructor() {
            this.controllers = new Is(ws, "datasets", !0), this.elements = new Is(Ms, "elements"), this.plugins = new Is(Object, "plugins"), this.scales = new Is(Es, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
        }
        add(...t) {
    ...
    function Us(t, e) {
        let i = $s.get(t);
        return i || (i = e(), $s.set(t, i), Ys.add(i)), i
    }
    const Xs = (t, e, i) => {
        const s = lt(e, i);
        void 0 !== s && t.add(s)
    ...
    class qs {
        constructor(t) {
            this._config = function (t) {
                return (t = t || {}).data = js(t.data), Hs(t), t
        ...
        getOptionScopes(t, e, i) {
            ...
            const r = new Set;
            e.forEach((e => {
                t && (r.add(t), e.forEach((e => Xs(r, t, e)))), e.forEach((t => Xs(r, s, t))), e.forEach((t => Xs(r, ft[n] || {}, t))), e.forEach((t => Xs(r, xt, t))), e.forEach((t => Xs(r, gt, t)))
            }));
        ...
        createResolver(t, e, i = [""], s) {
            const {
                resolver: n
            } = Ks(this._resolverCache, t, i);
            return U(e) ? si(n, e, void 0, s) : n
        }
    }
    ...
    function Qs(t, e) {
        return "top" === t || "bottom" === t || -1 === Zs.indexOf(t) && "x" === e
    }
    ...
    class an {
        ...
        _resize(t, e) {
            ...
            this.width = o.width, this.height = o.height, this._aspectRatio = this.aspectRatio, we(this, a, !0) && (this.notifyPlugins("resize", {
                size: o
            }), Q(i.onResize, [this, o], this), this.attached && this._doResize(r) && this.render())
        }
        ensureScalesHaveIDs() {
        ...
        buildOrUpdateScales() {
            ...
            e && (n = n.concat(Object.keys(e).map((t => {
                ...
                ei.configure(this, t, t.options), ei.addBox(this, t)
            }))
        }
        _updateMetasets() {
        ...
        update(t) {
            ...
            const n = new Set(Object.keys(this._listeners)),
                o = new Set(i.events);
            if (ut(n, o) && !!this._responsiveListeners === i.responsive || (this.unbindEvents(), this.bindEvents()), this._plugins.invalidate(), !1 === this.notifyPlugins("beforeUpdate", {
                    mode: t,
                    cancelable: !0
                })) return;
            ...
            for (let t = 0, e = this.data.datasets.length; t < e; t++) {
                const {
                    controller: e
                } = this.getDatasetMeta(t), i = !s && -1 === a.indexOf(e);
                e.buildOrUpdateElements(i), r = Math.max(+e.getMaxOverflow(), r)
            }
            r = this._minPadding = i.layout.autoPadding ? r : 0, this._updateLayout(r), s || J(a, (t => {
                t.reset()
            })), this._updateDatasets(t), this.notifyPlugins("afterUpdate", {
                mode: t
            }), this._layers.sort(Js("z", "_idx")), this._lastEvent && this._eventHandler(this._lastEvent, !0), this.render()
        }
        _updateLayout(t) {
        ...
        _updateDatasets(t) {
            if (!1 !== this.notifyPlugins("beforeDatasetsUpdate", {
                ...
                for (let e = 0, i = this.data.datasets.length; e < i; ++e) this._updateDataset(e, dt(t) ? t({
                    datasetIndex: e
                }) : t);
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", {
                cancelable: !0
            }) && (a.has(this) ? this.attached && !a.running(this) && a.start(this) : (this.draw(), tn({
                chart: this
            })))
        }
        draw() {
        ...
        _drawDataset(t) {
            ...
            !1 !== this.notifyPlugins("beforeDatasetDraw", o) && (s && Zt(e, {
                left: !1 === i.left ? 0 : n.left - i.left,
                right: !1 === i.right ? this.width : n.right + i.right,
                top: !1 === i.top ? 0 : n.top - i.top,
                bottom: !1 === i.bottom ? this.height : n.bottom + i.bottom
            }), t.controller.draw(), s && Qt(e), o.cancelable = !1, this.notifyPlugins("afterDatasetDraw", o))
        }
    ...
    function mn(t, e, i, s) {
        ...
        "middle" === n && i && (t.enableBorderRadius = !0, (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[xn(c, a, r, l)] = !0, n = h)), o[xn(n, a, r, l)] = !0, t.borderSkipped = o
    }

    function xn(t, e, i, s) {
        var n, o, a;
        return s ? (a = i, t = bn(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = bn(t, e, i), t
    }
    ...
    class yn extends ws {
        ...
        parseObjectData(t, e, i, s) {
            ...
            let d, u, f, g;
            for (d = i, u = i + s; d < u; ++d) g = e[d], f = {}, f[n.axis] = n.parse(lt(g, l), d), c.push(fn(lt(g, h), f, o, d));
            return c
        }
        updateRangeFromParsed(t, e, i, s) {
            ...
            for (let c = e; c < e + i; c++) {
                const e = this.getParsed(c),
                    ...
                    p = {
                        horizontal: l,
                        base: i.base,
                        enableBorderRadius: !g || pn(e._custom) || o === g._top || o === g._bottom,
                        x: l ? i.head : f.center,
                        y: l ? f.center : i.head,
        ...
        _calculateBarValuePixels(t) {
            ...
            } = this, o = s || 0, a = this.getParsed(t), r = a._custom, l = pn(r);
            let h, c, d = a[e.axis],
                u = 0,
    ...
    function Rn(t, e, i, s, n) {
        const {
            options: o
        } = e, a = "inner" === o.borderAlign;
        o.borderWidth && (a ? (t.lineWidth = 2 * o.borderWidth, t.lineJoin = "round") : (t.lineWidth = o.borderWidth, t.lineJoin = "bevel"), e.fullCircles && function (t, e, i) {
            const {
                x: s,
                y: n,
                startAngle: o,
            ...
            let c;
            for (i && On(t, e, o + _t), t.beginPath(), t.arc(s, n, h, o + _t, o, !0), c = 0; c < r; ++c) t.stroke();
            for (t.beginPath(), t.arc(s, n, l, o, o + _t), c = 0; c < r; ++c) t.stroke()
        }(t, e, a), a && On(t, e, n), Ln(t, e, i, s, n), t.stroke())
    }
    class En extends Ms {
        constructor(t) {
    ...
    function Bn(t, e, i, s) {
        const {
            ...
            loop: l,
            ilen: h
        } = Fn(n, i, s), c = function (t) {
            return t.stepped ? Jt : t.tension || "monotone" === t.cubicInterpolationMode ? te : zn
        }(o);
        let d, u, f, {
            move: g = !0,
            reverse: p
    ...
    function Hn(t, e, i, s) {
        Nn && !e.options.segment ? function (t, e, i, s) {
            ...
            for (const r of n) In(t, o, r.style), t.beginPath(), a(t, e, r, {
                start: i,
                end: i + s - 1
    ...
    class jn extends Ms {
        ...
        get segments() {
            return this._segments || (this._segments = Bi(this, this.options.segment))
        }
        first() {
        ...
        interpolate(t, e) {
            ...
            const a = [],
                r = function (t) {
                    return t.stepped ? Di : t.tension || "monotone" === t.cubicInterpolationMode ? Ci : Pi
                }(i);
            let l, h;
        ...
        const e = Un(t),
            ...
            n = function (t, e, i) {
                const s = t.options.borderWidth,
                    ...
                    o = ze(s);
                return {
                    t: Xn(n.top, o.top, 0, i),
                    r: Xn(n.right, o.right, 0, e),
                    b: Xn(n.bottom, o.bottom, 0, i),
                    l: Xn(n.left, o.left, 0, e)
                }
            }(t, i / 2, s / 2),
            o = function (t, e, i) {
                const {
                    enableBorderRadius: s
                } = t.getProps(["enableBorderRadius"]), n = t.options.borderRadius, o = Fe(n), a = Math.min(e, i), r = t.borderSkipped, l = s || U(n);
                return {
                    topLeft: Xn(!l || r.top || r.left, o.topLeft, 0, a),
                    topRight: Xn(!l || r.top || r.right, o.topRight, 0, a),
                    bottomLeft: Xn(!l || r.bottom || r.left, o.bottomLeft, 0, a),
                    bottomRight: Xn(!l || r.bottom || r.right, o.bottomRight, 0, a)
                }
            }(t, i / 2, s / 2);
        return {
            outer: {
    ...
    class Qn extends Ms {
        ...
        draw(t) {
            const {
                ...
                inner: n,
                outer: o
            } = qn(this), a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? se : Gn;
            var r;
        ...
        beforeElementsUpdate: (t, e, i) => {
            ...
            t.data.datasets.forEach(((e, n) => {
                ...
                let {
                    ...
                    return l && (n = Ht(oe(e, o.axis, a).lo, 0, i - 1)), s = h ? Ht(oe(e, o.axis, r).hi + 1, n, i) - n : i - n, {
                        start: n,
                        count: s
                    }
                }(r, l);
    ...
    function oo(t) {
        return (t.scale || {}).getPointPositionForValue ? function (t) {
            const {
                scale: e,
                fill: i
            } = t, s = e.options, n = e.getLabels().length, o = [], a = s.reverse ? e.max : e.min, r = s.reverse ? e.min : e.max;
            let l, h, c;
            if (c = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue(), s.grid.circular) return h = e.getPointPositionForValue(0, a), new no({
                x: h.x,
                y: h.y,
    ...
    function ho(t) {
        ...
        if ("stack" === i) return function (t) {
            ...
            for (let t = 0; t < o.length; t++) {
                const e = o[t];
                for (let t = e.start; t <= e.end; t++) ro(n, a[t], r)
            }
            return new jn({
                points: n,
                options: {}
    ...
    function _o(t, e, i) {
        ...
        s && n.points.length && (Zt(t, i), function (t, e) {
            ...
            t.save(), "x" === l && o !== n && (fo(t, s, a.top), bo(t, {
                line: i,
                target: s,
                color: n,
                scale: r,
                property: l
            }), t.restore(), t.save(), fo(t, s, a.bottom)), bo(t, {
                line: i,
                target: s,
                color: o,
                scale: r,
    ...
    var yo = {
        ...
        afterDatasetsUpdate(t, e, i) {
            const s = (t.data.datasets || []).length,
                n = [];
            let o, a, r, l;
            for (a = 0; a < s; ++a) o = t.getDatasetMeta(a), r = o.dataset, l = null, r && r.options && r instanceof jn && (l = {
    ...
    class wo extends Ms {
        ...
        _draw() {
            const {
                ...
                align: a,
                labels: r
            } = t, l = xt.color, h = Ti(t.rtl, this.left, this.width), c = Ve(r.font), {
                color: d,
                padding: u
            } = r, f = c.size, g = f / 2;
            let p;
            ...
            const {
                ...
                boxHeight: x,
                itemHeight: b
            } = vo(r, f), _ = this.isHorizontal(), y = this._computeTitleHeight();
            p = _ ? {
                ...
                ! function (t, e, i) {
                    ...
                    if (s.fillStyle = K(i.fillStyle, l), s.lineCap = K(i.lineCap, "butt"), s.lineDashOffset = K(i.lineDashOffset, 0), s.lineJoin = K(i.lineJoin, "miter"), s.lineWidth = n, s.strokeStyle = K(i.strokeStyle, l), s.setLineDash(K(i.lineDash, [])), r.usePointStyle) {
                        ...
                        const o = e + Math.max((f - x) / 2, 0),
                            a = h.leftForLtr(t, m),
                            r = Fe(i.borderRadius);
                        s.beginPath(), Object.values(r).some((t => 0 !== t)) ? se(s, {
                            x: a,
                            y: o,
                            w: m,
                            h: x,
                            radius: r
                        }) : s.rect(a, o, m, x), s.fill(), 0 !== n && s.stroke()
                    }
                    s.restore()
                }(h.x(D), C, w), D = o(S, D + m + g, _ ? D + P : this.right, t.rtl),
                    function (t, e, i) {
                        ee(s, i.text, t, e + b / 2, c, {
    ...
    var Mo = {
        ...
        stop(t) {
            ei.removeBox(t, t.legend), delete t.legend
        },
        beforeUpdate(t, e, i) {
            const s = t.legend;
    ...
    class ko extends Ms {
        ...
        _drawArgs(t) {
            ...
            let l, h, c, d = 0;
            return this.isHorizontal() ? (h = n(r, i, o), c = e + t, l = o - i) : ("left" === a.position ? (h = i + t, c = n(r, s, e), d = -.5 * bt) : (h = o - t, c = n(r, e, s), d = .5 * bt), l = s - e), {
                titleX: h,
                titleY: c,
                maxWidth: l,
                rotation: d
    ...
    var Do = {
        ...
        stop(t) {
            ei.removeBox(t, Po.get(t)), Po.delete(t)
        },
        beforeUpdate(t, e, i) {
            const s = Po.get(t);
            ei.configure(t, s, i), s.options = i
    ...
    function Lo(t, e) {
        ...
        return i.save(), i.font = h.string, J(t.title, _), i.font = l.string, J(t.beforeBody.concat(t.afterBody), _), b = e.displayColors ? a + 2 + e.boxPadding : 0, J(s, (t => {
            J(t.before, _), J(t.lines, _), J(t.after, _)
        })), b = 0, i.font = c.string, J(t.footer, _), i.restore(), m += g.width, {
            width: m,
            height: p
        }
    }
    ...
    function Io(t, e, i, s) {
        ...
        return "center" === l ? "left" === r ? g += h : "right" === r && (g -= h) : "left" === r ? g -= Math.max(c, u) + o : "right" === r && (g += Math.max(d, f) + o), {
            x: Ht(g, 0, s.width - e.width),
            y: Ht(p, 0, s.height - e.height)
        }
    }
    ...
    class Vo extends Ms {
        ...
        getContext() {
            return this.$context || (this.$context = (t = this._chart.getContext(), e = this, i = this._tooltipItems, He(t, {
                tooltip: e,
                tooltipItems: i,
                type: "tooltip"
            })));
        ...
        getTitle(t, e) {
            ...
            let a = [];
            return a = Oo(a, Ao(s)), a = Oo(a, Ao(n)), a = Oo(a, Ao(o)), a
        }
        getBeforeBody(t, e) {
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = zo(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = Ve(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r) e.fillText(s[r], l.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + a, r + 1 === n && (t.y += i.titleMarginBottom - a)
            }
        }
        _drawColorBox(t, e, i, s, n) {
            ...
            if (n.usePointStyle) {
                ...
                const e = s.leftForLtr(u, l - h),
                    ...
                    a = Fe(o.borderRadius);
                Object.values(a).some((t => 0 !== t)) ? (t.beginPath(), t.fillStyle = n.multiKeyBackground, se(t, {
                    x: e,
                    y: g,
                    w: l,
                    h: r,
                    radius: a
                }), t.fill(), t.stroke(), t.fillStyle = o.backgroundColor, t.beginPath(), se(t, {
                    x: i,
                    y: g + 1,
                    w: l - 2,
                    h: r - 2,
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = zo(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = Ve(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a) e.fillText(s[a], r.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + i.footerSpacing
            }
        }
        ...
        handleEvent(t, e) {
            ...
            return n = e || !tt(o, s) || a, n && (this._active = o, (i.enabled || i.external) && (this._eventPosition = {
                x: t.x,
                y: t.y
            }, this.update(!0, e))), n
        }
    ...
    function Ho(t, e, i) {
        const s = t.indexOf(e);
        if (-1 === s) return ((t, e, i) => "string" == typeof e ? t.push(e) - 1 : isNaN(e) ? null : i)(t, e, i);
    ...
    class jo extends Es {
        ...
        parse(t, e) {
            ...
            return ((t, e) => null === t ? null : Ht(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : Ho(i, t, K(e, t)), i.length - 1)
        }
        determineDataLimits() {
            const {
                minDefined: t,
    ...
    jo.id = "category", jo.defaults = {
        ticks: {
            callback: jo.prototype.getLabelForValue
        }
    };
    class Yo extends Es {
        constructor(t) {
        ...
        buildTicks() {
            ...
            const s = function (t, e) {
                ...
                for (m && (d && v !== o ? (i.push({
                        value: o
                    }), v < o && P++, Tt(Math.round((v + P * k) * y) / y, o, $o(o, _, t)) && P++) : v < o && P++); P < M; ++P) i.push({
                    value: Math.round((v + P * k) * y) / y
                });
                return x && d && w !== a ? i.length && Tt(i[i.length - 1].value, a, $o(a, _, t)) ? i[i.length - 1].value = a : i.push({
                    value: a
                }) : x && w !== a || i.push({
                    value: w
                }), i
        ...
        getLabelForValue(t) {
            return Ai(t, this.chart.options.locale)
        }
    }
    class Uo extends Yo {
        determineDataLimits() {
    ...
    class qo extends Es {
        ...
        getLabelForValue(t) {
            return void 0 === t ? "0" : Ai(t, this.chart.options.locale)
        }
        configure() {
            const t = this.min;
        ...
        getPixelForValue(t) {
            return void 0 !== t && 0 !== t || (t = this.min), null === t || isNaN(t) ? NaN : this.getPixelForDecimal(t === this.min ? 0 : (Pt(t) - this._startValue) / this._valueRange)
        }
        getValueForPixel(t) {
    ...
    function Zo(t) {
        ...
        for (let h = 0; h < o; h++) {
            ...
            const c = t.getPointPosition(h, t.drawingArea + n[h]),
                d = Ve(o.font),
                u = (a = t.ctx, r = d, l = Y(l = t._pointLabels[h]) ? l : [l], {
                    w: Ut(a, r.string, l),
    ...
    class sa extends Yo {
        ...
        setDimensions() {
            this.width = this.maxWidth, this.height = this.maxHeight, this.paddingTop = Ko(this.options) / 2, this.xCenter = Math.floor(this.width / 2), this.yCenter = Math.floor((this.height - this.paddingTop) / 2), this.drawingArea = Math.min(this.height - this.paddingTop, this.width) / 2
        }
        determineDataLimits() {
            const {
                min: t,
        ...
        generateTickLabels(t) {
            Yo.prototype.generateTickLabels.call(this, t), this._pointLabels = this.getLabels().map(((t, e) => {
        ...
        drawGrid() {
            ...
            if (e.pointLabels.display && function (t, e) {
                    ...
                    for (let n = e - 1; n >= 0; n--) {
                        ...
                        ee(i, t._pointLabels[n], a, r + o.lineHeight / 2, o, {
                            color: e.color,
                            textAlign: l,
                            textBaseline: "middle"
                        })
    ...
    sa.id = "radialLinear", sa.defaults = {
        display: !0,
        animate: !0,
        position: "chartArea",
        angleLines: {
    ...
    class da extends Es {
        ...
        parse(t, e) {
            return void 0 === t ? null : ra(this, t)
        }
        beforeLayout() {
        ...
        buildTicks() {
            ...
            const n = this.min,
                o = re(s, n, this.max);
            return this._unit = e.unit || (i.autoSkip ? la(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function (t, e, i, s, n) {
                for (let o = oa.length - 1; o >= oa.indexOf(i); o--) {
                    const i = oa[o];
                    if (na[i].common && t._adapter.diff(n, s, i) >= e - 1) return i
                }
                return oa[i ? oa.indexOf(i) : 0]
        ...
        initOffsets(t) {
            ...
            s = Ht(s, 0, o), n = Ht(n, 0, o), this._offsets = {
                start: s,
                end: n,
                factor: 1 / (s + 1 + n)
            }
        ...
        getLabelTimestamps() {
            ...
            for (e = 0, i = s.length; e < i; ++e) t.push(ra(this, s[e]));
    ...
    return an.register(Cn, ga, Jn, No), an.helpers = {
        ...Hi
