            ...
            <li><a><i class="fa fa-edit"></i> Data Input <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li class="active"><a> <i class="fa fa-cubes"></i> Inventory<span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li class="active"><a href="<?= base_url('input_data/data.php') ?>">Daily</a></li>
...
<div class="right_col" role="main">
    <div class="row">
        <div class="col-8">
            <h2>Data Input | Inventory | Daily</h2>
        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-7">
                                                                                <select id="provinsi" style="text-align: left;" name="name_kabinet" class="form-select" required>
                                                                                    <?php
                                                                                    $query = mysqli_query($conn, "SELECT distinct(name_kabinet) as name_kabinet, gmc FROM inventory ORDER BY name_kabinet asc");
                                                                                    while ($row = mysqli_fetch_array($query)) {
                                                                                    ?>
                                                                                        <option value="<?php echo $row['gmc']; ?>"><?php echo $row['name_kabinet']; ?></option>
                                                                                    <?php } ?>
                                                                                </select>
                                                                            </div>
                                                                        </div>
