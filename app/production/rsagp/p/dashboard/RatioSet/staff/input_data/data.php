...
?>
                ...
                <li><a><i class="fa fa-edit"></i> Entry Data <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li class="active"><a> <i class="fa fa-cubes"></i> Inventory<span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <li class="active"><a href="<?= base_url('staff/input_data/data.php') ?>">Daily</a></li>
    ...
    <div class="right_col" role="main">
        <div class="row">
            <div class="col-8">
                <h2>Entry Data | Inventory | Daily</h2>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                                                        <select id="provinsi" name="name_kabinet" style="color: black">
