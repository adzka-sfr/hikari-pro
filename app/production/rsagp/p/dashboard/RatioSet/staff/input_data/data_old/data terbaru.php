...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        <ul class="nav side-menu">
            <li class=""><a href="<?= base_url('dashboard') ?>"><i class="fa fa-desktop"></i> Rasio Set</a></li>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            ?>
                                            <a href=" #" type="button" style="width: 150px" class="btn btn-success" data-toggle="modal" data-target="#myModal<?php echo $antrian; ?>"><i class="glyphicon glyphicon-plus"></i> Add Inventory</a>
                                            <div class="modal fade" id="myModal<?php echo $antrian ?>" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Add Inventory Kabinet Piano</h4>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-7">
                                                                                <select id="provinsi" style="text-align: left;" name="name_kabinet" class="form-select" required>
                                                                                    <?php
                                        ...
                                        <!-- end add plan -->
                                        <!-- <div class="col-2">
                                            <select class="form-control mb-3" style="border-radius: 0.25rem; border: 2px solid skyblue;" id="myInput1" onkeyup="myFunction1()" aria-label="Default select example">
                                        ...
                                        <!-- <div class="col-2 ">
                                            <div class="col-12">
                                                <div class="search" style="position: relative">
                                                    ...
                                                    <input type="text" class="form-control mb-3" style="border-radius: 0.25rem; text-indent: 25px; border: 2px solid skyblue;" id="myInput1" onkeyup="myFunction1()" placeholder="Dest.." title="Type in a name">
                                                </div>
                                            </div>
                                        </div> -->
...
<script>
    ...
    //     var input1, filter1, table1, tr, td, i, txtValue;
