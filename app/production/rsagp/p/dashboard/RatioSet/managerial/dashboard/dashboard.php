            ...
            <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-edit"></i> Entry Data<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        ...
                        <li class=""><a href="<?= base_url('managerial/plan/plan.php') ?>"><i class="fa fa-calendar-plus-o"></i> Plan</a></li>
                        <!-- <li class=""><a href="<?= base_url('checkout/checkout.php') ?>"><i class="fa fa-shopping-cart"></i> Checkout</a></li> -->
                    </ul>
                </li>
                <li class=""><a href="<?= base_url('managerial/priority/priority.php') ?>"><i class='fa fa-signal'></i> Priority</a></li>
            </ul>
        </div>
    </div>
    </div>
