        ...
        <div class="col">
            <div class="card">
                <div class="card-body" style="text-align: center; padding-top: 5px; padding-bottom: 5px;">
                    <b style="font-size: 30px; text-align: center; padding-top: 5px; padding-bottom: 5px;">CABINET G 150 DESTINATION</b>
                </div>
            </div>
        </div>
    </div>
        ...
        function update() {
            $.getJSON("G1.php", function(data) {
                ...
                $.each(data.result, function() {
                    $("table").append("<tr><td>" + (no++) + "</td><td>" + this['name_cabinet'] + "</td><td style='text-align:left'>" + this['name_piano'] + "</td><td ><h1 style='border-radius: 0.25rem; background-color: #DEEDFF; text-align: center; margin-right: 30px '>" + this['pcs_prioritas'] + "</h1></td></tr>");
                });
            });
        }
    </script>
