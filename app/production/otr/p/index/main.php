...
<body class="nav-md footer_fixed">
    <div class="container body">
        <div class="main_container">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <!-- coba di kasih if untuk memberikan efek aktif -->
                                <li <?php if ($_GET['p'] == "db") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?p=db"><i class="fa fa-desktop"></i> Dashboard</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['p'] == "pu") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?p=pu"><i class="fa fa-cloud-upload"></i> Upload UP Plan</a>
                                </li>
                            </ul>
                            <ul class="nav side-menu">
                                <li <?php if ($_GET['p'] == "pg") {
                                        echo 'class="active"';
                                    } ?>><a href="main.php?p=pg"><i class="fa fa-cloud-upload"></i> Upload GP Plan</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <!-- /page content -->
            <?php
            include 'bar_chart/planXtargetup.php';
            include 'bar_chart/planXtargetgp.php';
            ?>
