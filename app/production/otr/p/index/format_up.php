...
// membuat sheet baru
$sheet = new \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet($spreadsheet, 'Resume of plan'); //deklarasi nama sheet
...
// isi judul
$sheet->setCellValue('A1', 'Plan Date (ex: 2022-08-25)');
$sheet->setCellValue('B1', 'Total Qty (ex: 110)');
$sheet->setCellValue('C1', 'Work  Center (ex: U200)');
...
$writer->save('upload_plan/resume_plan_up.xlsx');
echo "<script>window.location = 'upload_plan/resume_plan_up.xlsx'</script>";
?>