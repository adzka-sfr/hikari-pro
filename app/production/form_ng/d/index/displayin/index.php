        ...
        <div class="dashboard_graph">
            ...
            if (empty($_SESSION['cardnumber'])) {
                ...
                if ($ptng == 'U' or $ptng == 'u') {
                    ...
                    if (!empty($data['id'])) {
                        // JIKA DATA BENAR
                        $sql = mysqli_query($connect_pro, "SELECT res.id, reg.c_serialnumber, res.c_checker, res.c_pianoname FROM formng_resulti res JOIN formng_register reg ON res.c_serialnumber = reg.c_serialnumber WHERE reg.c_ctrlnumber = '$_SESSION[cardnumber]'");
                        $data = mysqli_fetch_array($sql);
            ...
            ?>
                    ...
                    if (!empty($data['id'])) {
                        // JIKA DATA BENAR
                        $sql = mysqli_query($connect_pro, "SELECT * FROM formng_resulti WHERE c_serialnumber = '$_SESSION[cardnumber]'");
                        $data = mysqli_fetch_array($sql);
                        $_SESSION['cardnumber'] = $data['c_serialnumber'];
                        $_SESSION['checker'] = $data['c_checker'];
                        $_SESSION['pianoname'] = $data['c_pianoname'];
