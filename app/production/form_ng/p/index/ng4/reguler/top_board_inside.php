<div class="row">
    <div class="col-md-12">
        ...
        ?>
        <div class="row">
            <div class="col-12" style="padding-top: 20px; padding-bottom: 25px;">
                <!-- gambar -->
                <center>
                    <div class="containere">
                        ...
                        while ($tbo1 = mysqli_fetch_array($tbo1_sql)) {
                            ...
                            $tbo2_sql = mysqli_query($connect_pro, "SELECT c_ng3 FROM formng_resulto1 WHERE c_serialnumber = '$serial_number' AND c_areacode = '$id' AND c_ng3 != ''");
                            $tbo2_data = mysqli_fetch_array($tbo2_sql);
                            if (empty($tbo2_data['c_ng3'])) {
            ...
            while ($modal_data = mysqli_fetch_array($modal_sql)) {
                ...
                $cabng = array();
                $a = 0;
                $cabsql = mysqli_query($connect_pro, "SELECT DISTINCT c_cabinet FROM formng_resulto1 WHERE c_serialnumber = '$serial_number' AND c_areacode = '$id' AND c_ng3 != ''");
                    ...
                    <div class="modal-dialog modal-xl">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6" style="text-align: right;">
                                            <span style="font-size: 15px ; font-style: italic;">Outside Check 3</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="halodeck" name="ng1[]" multiple="multiple" style="width:100%;">
                                                        ...
                                                        for ($i = 0; $i < count($data_ng); $i++) {
                                                            // cek data ng yang sudah tersimpan
                                                            if (!empty($cabng[0])) {
                                                                $modal_sql1 = mysqli_query($connect_pro, "SELECT c_ng3 FROM formng_resulto1 WHERE c_serialnumber = '$serial_number' AND c_areacode = '$id' AND c_cabinet = '$cabng[0]' AND c_ng3 = '$data_ng[$i]'");
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="halodeck" name="ng2[]" multiple="multiple" style="width:100%;">
                                                        ...
                                                        for ($i = 0; $i < count($data_ng); $i++) {
                                                            // cek data ng yang sudah tersimpan
                                                            if (!empty($cabng[1])) {
                                                                $modal_sql1 = mysqli_query($connect_pro, "SELECT c_ng3 FROM formng_resulto1 WHERE c_serialnumber = '$serial_number' AND c_areacode = '$id' AND c_cabinet = '$cabng[1]' AND c_ng3 = '$data_ng[$i]'");
                                                                if (empty(mysqli_fetch_array($modal_sql1))) {
                                                                    $sel = '';
                                                                } else {
                                                                    $sel = 'selected';
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="halodeck" name="ng3[]" multiple="multiple" style="width:100%;">
                                                        ...
                                                        for ($i = 0; $i < count($data_ng); $i++) {
                                                            // cek data ng yang sudah tersimpan
                                                            if (!empty($cabng[2])) {
                                                                $modal_sql1 = mysqli_query($connect_pro, "SELECT c_ng3 FROM formng_resulto1 WHERE c_serialnumber = '$serial_number' AND c_areacode = '$id' AND c_cabinet = '$cabng[2]' AND c_ng3 = '$data_ng[$i]'");
                                                                if (empty(mysqli_fetch_array($modal_sql1))) {
                                                                    $sel = '';
                                                                } else {
                                                                    $sel = 'selected';
                        ...
                        if (isset($_POST[$id])) {
                            ...
                            if (empty($_POST['cab1']) and empty($_POST['cab2']) and empty($_POST['cab3'])) {
                                $pp1 = mysqli_query($connect_pro, "UPDATE formng_resulto1 SET c_ng3 = '', c_inspectiondate3 = null, c_checker3 = '' where c_serialnumber = '$serial_number' AND c_areacode = '$id'");
                            } else {
                                    ...
                                    if (!empty($_POST['ng1'])) {
                                        foreach ($_POST['ng1'] as $value) {
                                            ...
                                            if (empty($data1['id'])) {
                                                ...
                                                if (empty($data2['id'])) {
                                                    $sql3 = mysqli_query($connect_pro, "SELECT id FROM formng_resulto1 WHERE c_serialnumber = '$serial_number' AND c_areacode = '$id' AND c_cabinet = '$cab' AND c_ng3 = '$value'");
                                                    $data3 = mysqli_fetch_array($sql3);
                                                    if (empty($data3['id'])) {
                                                        $pp1 = mysqli_query($connect_pro, "INSERT INTO formng_resulto1 SET c_serialnumber = '$serial_number', c_pianoname = '$piano_name', c_section = '$section', c_arealabel = '$label', c_areacode = '$id',c_cabinet = '$cab', c_ng3 = '$value', c_inspectiondate3 = '$date_in', c_checker3 = '$_SESSION[nama]' "); // sudah benar
                                                    } else {
                                                        $pp1 = mysqli_query($connect_pro, "UPDATE formng_resulto1 SET c_ng3 = '$value', c_inspectiondate3 = '$date_in', c_checker3 = '$_SESSION[nama]' WHERE c_serialnumber = '$serial_number' AND c_areacode = '$id' AND c_cabinet = '$cab'");
                                                    }
                                                } else {
                                                    $pp1 = mysqli_query($connect_pro, "UPDATE formng_resulto1 SET c_ng3 = '$value', c_inspectiondate3 = '$date_in', c_checker3= '$_SESSION[nama]' WHERE c_serialnumber = '$serial_number' AND c_areacode = '$id' AND c_cabinet = '$cab' AND c_ng2 ='$value'");
                                                }
                                            } else {
                                                $pp1 = mysqli_query($connect_pro, "UPDATE formng_resulto1 SET c_ng3 = '$value', c_inspectiondate3 = '$date_in', c_checker3 = '$_SESSION[nama]' WHERE c_serialnumber = '$serial_number' AND c_areacode = '$id' AND c_cabinet = '$cab' AND c_ng1 ='$value'");
                                            }
                                        }
                                    }
                                }
                            ...
                            mysqli_query($connect_pro, "DELETE FROM formng_resulto1 WHERE c_serialnumber = '$serial_number' AND c_ng1 = '' AND c_ng2 = '' AND c_ng3 = ''");
    ...
    <div class="col-12 tableFixHead-3">
        <table class="table table-striped">
            ...
            <tbody>
                <?php
                $no = 1;
                $his_ng = mysqli_query($connect_pro, "SELECT * FROM formng_resulto1 WHERE c_serialnumber = '$serial_number' AND c_section = '$section' AND c_ng3 != '' ORDER BY c_arealabel desc ");
                ...
                ?>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $his_ng_data['c_ng3'] ?></td>
                            <td style="text-align: center;"><?= $his_ng_data['c_inspectiondate3'] ?></td>
                        </tr>
                <?php
                        $no++;
                    }
