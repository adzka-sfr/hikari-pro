...
<?php
        ...
        mysqli_query($connect_pro, "INSERT INTO formng_resultro SET c_serialnumber = '$serial_number', c_pianoname = '$piano_name', c_inspectiondate = '$drn', c_checker = '$_SESSION[nama]', c_process = 'oc3'");
    }
}
?>