...
// cek apakah masih ada data ng untuk no ng terkait
$sql = mysqli_query($connect_pro, "SELECT id FROM formng_resultong WHERE c_serialnumber = '$c_serialnumber' AND c_numberng = $c_numberng");
