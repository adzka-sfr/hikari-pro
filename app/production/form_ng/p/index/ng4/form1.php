...
<div class="dashboard_graph" style="margin-top: 10px; padding-bottom: 50px;">
    ...
    <div class="row">
        ...
        <div class="col-2" style="text-align: right;">
            ...
            // mengambil nilai penomoran NG terbesar
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                while ($data = mysqli_fetch_array($sql)) {
                                    ...
                                    $nolist = 0;
                                    $active_sql_edit = mysqli_query($connect_pro, "SELECT c_cabinet FROM formng_resultong WHERE c_serialnumber = '$serial_number' AND c_numberng = $data[c_numberng] AND c_process = '$process'");
