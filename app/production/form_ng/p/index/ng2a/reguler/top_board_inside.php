    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-12" style="text-align: right;">
                ...
                if (empty($data['id'])) {
                ?>
                    <button disabled name="ra_tbi" class="btn btn-sm btn-primary">Repair All in TBI</button>
                <?php
                } else {
                ?>
                    <form method="post">
                        ...
                        <button name="ra_tbi" class="btn btn-sm btn-primary">Repair All in TBI</button>
                    </form>

                    <?php
                    if (isset($_POST['ra_tbi'])) {
                    ?>
                        <script>
                            Swal.fire({
                                title: 'Repair semua pada TBI?',
    ...
    <div class="col-12">
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                <?php
                $no = 1;
                $his_ng = mysqli_query($connect_pro, "SELECT * FROM formng_resultro WHERE c_serialnumber = '$serial_number' AND c_section = '$section' ORDER BY c_areacode asc");
