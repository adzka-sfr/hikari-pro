...
<div class="dashboard_graph" style="margin-top: 10px; padding-bottom: 50px;">
            ...
            <div class="col-md-12">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        $i = 0;
                        $ng = 0;
                        $sql2 = mysqli_query($connect_pro, "SELECT * FROM formng_checkcomplete WHERE c_type = 'b' ORDER BY id asc");
    ...
    if (isset($_POST['verif'])) {
        ...
        for ($in = 1; $in <= $i; $in++) {
            ...
            $sql1 = mysqli_query($connect_pro, "INSERT INTO formng_resultc SET c_serialnumber = '$c_serialnumber', c_pianoname = '$c_pianoname', c_partname = '$c_partname', c_result1 = '$c_result1', c_inspectiondate1 = '$c_inspectiondate1', c_checker1 = '$c_checker1'");
        }
        if ($sql1) {
