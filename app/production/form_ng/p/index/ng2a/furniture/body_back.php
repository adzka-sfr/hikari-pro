    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-12" style="text-align: right;">
                ...
                if (empty($data['id'])) {
                ?>
                    <button disabled name="ra_bb" class="btn btn-sm btn-primary">Repair All in BB</button>
                <?php
                } else {
                ?>
                    <form method="post">
                        ...
                        <button name="ra_bb" class="btn btn-sm btn-primary">Repair All in BB</button>
                    </form>

                    <?php
                    if (isset($_POST['ra_bb'])) {
                    ?>
                        <script>
                            Swal.fire({
                                title: 'Repair semua pada BB?',
