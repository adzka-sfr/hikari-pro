    ...
    <div class="col-md-12">
        <table class="table table-bordered">
            ...
            while ($verif_data1 = mysqli_fetch_array($verif_sql1)) {
                ...
                // section
                if ($verif_data1['c_section'] == 'top board outside') {
                    $section = 'TBO';
                } elseif ($verif_data1['c_section'] == 'top board inside') {
                    $section = 'TBI';
                } elseif ($verif_data1['c_section'] == 'upper keyboard') {
                    $section = 'UK';
                } elseif ($verif_data1['c_section'] == 'body') {
                    $section = 'B';
                } elseif ($verif_data1['c_section'] == 'body back') {
                    $section = 'BB';
                }
...
if (isset($_POST['str'])) {
    $sql1 = mysqli_query($connect_pro, "SELECT id FROM formng_resulto1 WHERE c_serialnumber = '$serial_number'");
    $data1 = mysqli_fetch_array($sql1);
    if (!empty($data1)) {
        $sql1 = mysqli_query($connect_pro, "SELECT * FROM formng_resulto1 WHERE c_serialnumber = '$serial_number'");
        $drn = date('Y-m-d H:i:s', strtotime($now));
        while ($data1 = mysqli_fetch_array($sql1)) {
            $ppp1 = mysqli_query($connect_pro, "INSERT INTO formng_resultro SET c_serialnumber = '$data1[c_serialnumber]', c_pianoname = '$data1[c_pianoname]', c_inspectiondate = '$drn', c_checker = '$data1[c_checker1]', c_process = 'oc1', c_section = '$data1[c_section]', c_areacode = '$data1[c_areacode]', c_ng = '$data1[c_ng1]'");
        }
        if ($ppp1) {
    ?>
            <script>
...
<?php
        ...
        mysqli_query($connect_pro, "INSERT INTO formng_resultro SET c_serialnumber = '$serial_number', c_pianoname = '$piano_name', c_inspectiondate = '$drn', c_checker = '$_SESSION[nama]', c_process = 'oc1'");
    }
}
?>