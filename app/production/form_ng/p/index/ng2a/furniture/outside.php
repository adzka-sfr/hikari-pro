                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            while ($data = mysqli_fetch_array($sql)) {
                                ...
                                $ng_active = array();
                                $nolist = 0;
                                $active_sql = mysqli_query($connect_pro, "SELECT c_ng, c_repaired, c_numberng FROM formng_resultong WHERE c_serialnumber = '$serial_number' AND c_cabinet = '$data[c_cabinet]'");
                                while ($active_data = mysqli_fetch_array($active_sql)) {
                                    $ng_active[] = array($active_data['c_ng'], $active_data['c_repaired'], $active_data['c_numberng']);
                                    $nolist++;
                                }
                                ...
                                <tr>
                                    <td>
                                        ...
                                        for ($a = 0; $a < $count_cabactive; $a++) {
                                            ...
                                            $c_ng = $ng_active[$a][0];
                                            $merah_sql = mysqli_query($connect_pro, "SELECT id FROM formng_resultong WHERE c_serialnumber = '$serial_number' AND c_cabinet = '$data[c_cabinet]' AND c_ng = '$c_ng' AND c_process = 'oc1'");
                                            $merah_data = mysqli_fetch_array($merah_sql);
                                            if (!empty($merah_data)) {
                                                $warna_pen = '#DC4646';
                                            } else {
                                                $hijau_sql = mysqli_query($connect_pro, "SELECT id FROM formng_resultong WHERE c_serialnumber = '$serial_number' AND c_cabinet = '$data[c_cabinet]' AND c_ng = '$c_ng' AND c_process = 'oc2'");
                                                $hijau_data = mysqli_fetch_array($hijau_sql);
                                                if (!empty($hijau_data)) {
                                                    $warna_pen = '#5AA65A';
                                                } else {
                                                    $biru_sql = mysqli_query($connect_pro, "SELECT id FROM formng_resultong WHERE c_serialnumber = '$serial_number' AND c_cabinet = '$data[c_cabinet]' AND c_ng = '$c_ng' AND c_process = 'oc3'");
                                                    $biru_data = mysqli_fetch_array($biru_sql);
                                                    if (!empty($biru_data)) {
                                                        $warna_pen = '#1340FF';
                                                    } else {
                        ...
                        <tr>
                            <td colspan="2" style="text-align: center;">
                                ...
                                ?>
                                <button <?= $disbutall ?> id="repairall" class="btn btn-sm btn-primary" style="margin:0px; padding-top: 5px;">Repair All <i class="fa fa-wrench"></i></button>
                                <script>
                                    $(document).ready(function() {
