    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-12" style="text-align: right;">
                ...
                if (empty($data['id'])) {
                ?>
                    <button disabled name="ra_tbo" class="btn btn-sm btn-primary">Repair All in TBO</button>
                <?php
                } else {
                ?>
                    <form method="post">
                        ...
                        <button name="ra_tbo" class="btn btn-sm btn-primary">Repair All in TBO</button>
                    </form>

                    <?php
                    if (isset($_POST['ra_tbo'])) {
                    ?>
                        <script>
                            Swal.fire({
                                title: 'Repair semua pada TBO?',
