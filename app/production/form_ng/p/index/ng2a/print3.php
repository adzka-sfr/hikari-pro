...
<body>
    ...
    //get data ng
    $sql = mysqli_query($connect_pro, "SELECT * FROM formng_resulto1 WHERE c_serialnumber = '$serial' AND c_ng3 != '' order by c_arealabel");
    ...
    <div class="page">
        ...
        <div style="font-size: 12px; padding-left: 0px; margin-left: 0px;">
            ...
            <ul>
                ...
                ?>
                    <li>(<b><?= $section ?>_<?= $data['c_arealabel'] ?></b>) <?= $data['c_cabinet'] ?><br><b><?= $data['c_ng3'] ?></b></li>
                <?php
                }
                ?>
            </ul>
