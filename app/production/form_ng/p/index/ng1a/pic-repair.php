...
if (empty($_SESSION['repair_id'])) {
    ...
    $sql1 = mysqli_query($connect, "SELECT id FROM auth where id = '$_SESSION[repair_id]' AND role = 'repair incheck'");
...
?>
    ...
    <?php
        ...
        $sql1 = mysqli_query($connect, "SELECT nama FROM auth where id = '$_SESSION[repair_id]' AND role = 'repair incheck'");
