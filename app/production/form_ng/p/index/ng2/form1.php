...
<div class="dashboard_graph" style="margin-top: 10px; padding-bottom: 50px;">
    ...
    <div class="row" style="padding-top: 0px;">
        ...
        <div class="col-md-2" style="text-align: right;">
            <a href="verif.php"><button class="btn btn-success" style="height: 30px;padding-top: 2px; padding-bottom: 2px;border-top-left-radius:0px;border-top-right-radius:0px;border-bottom-right-radius:15px;border-bottom-left-radius:15px;">Verification</button></a>
        </div>
