...
// delete for location
mysqli_query($connect_pro, "DELETE FROM formng_resultoloc WHERE c_serialnumber = '$c_serialnumber' AND c_numberng = '$c_numberng'");
// delete for name of ng
mysqli_query($connect_pro, "DELETE FROM formng_resultong WHERE c_serialnumber = '$c_serialnumber' AND c_numberng = '$c_numberng'");
