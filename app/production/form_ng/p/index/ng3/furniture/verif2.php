                ...
                <div class="tab-pane fade show active" id="outsidecheck" role="tabpanel" aria-labelledby="outsidecheck-tab">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3 text-center">
                            ...
                            $sql_next = mysqli_query($connect_pro, "SELECT c_outcheck2by FROM formng_register WHERE c_serialnumber = '$serial_number'");
                            $data_next = mysqli_fetch_array($sql_next);
                            if ($data_next['c_outcheck2by'] != '') {
                            ?>
                            ...
                            ?>
                                <button <?= $disable ?> type="button" id="sendnext" class="btn btn-success">Kirim ke Outside Check 3</button>
                                <script>
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        success: function(dataResult) {
                                                            ...
                                                            if (dataResult.statusCode == 200) {
                                                                Swal.fire({
                                                                    title: 'Berhasil!',
                                                                    text: 'Data piano berhasil dikirim ke Outside Check 3!',
                                                                    icon: 'success',
                                                                    timer: 2000,
