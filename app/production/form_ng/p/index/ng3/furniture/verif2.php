            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="outsidecheck" role="tabpanel" aria-labelledby="outsidecheck-tab">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <?php
                            $sql4 = mysqli_query($connect_pro, "SELECT c_finishoutcheck2 FROM formng_register WHERE c_serialnumber = '$serial_number'");
                            $data4 = mysqli_fetch_array($sql4);
                            if (!empty($data4['c_finishoutcheck2'])) {
                            ?>
                                <div class="row">
                                    <div class="col-12" style="text-align: center; padding-top: 10px;">
                                        <button disabled name="str" class="btn btn-success">Data has been sent to Check 3</button>
                                    </div>
                                </div>
                            <?php
                            } else {
                                ...
                                <form method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-12" style="text-align: center; padding-top: 10px;">
                                            ...
                                            <button <?= $dis ?> type="submit" name="str" class="btn btn-success">Send to Check 3</button>
                                        </div>
                                    </div>
                                </form>
                            <?php
                    ...
                    if (isset($_POST['str'])) {
                        ...
                        $sql = mysqli_query($connect_pro, "SELECT c_checker FROM formng_resultro WHERE c_serialnumber = '$serial_number' AND c_process = 'oc2' limit 1");
                        $data = mysqli_fetch_array($sql);
                        $checker2 = $data['c_checker'];
                        if ($checker2 == $_SESSION['nama']) {
                            $tgl_fo1 = date('Y-m-d H:i:s', strtotime($now));
                            $ppp1 = mysqli_query($connect_pro, "UPDATE formng_register SET c_finishoutcheck2 = '$tgl_fo1', c_outcheck2by = '$_SESSION[nama]' WHERE c_serialnumber = '$serial_number'");
                            if ($ppp1) {
                    ?>
                                <script>
                                    $(document).ready(function() {
                                        Swal.fire({
                                            title: 'Success',
                                            html: 'Piano <br><b><?= $piano_name ?></b><br> has been sent to Check 3 !',
                                            type: 'success',
                            ...
                            <script>
                                $(document).ready(function() {
                                    Swal.fire({
                                        ...
                                        html: 'PIC checker dan PIC validasi harus sama<br>untuk serial number ini harus divalidasi oleh <u><?= $checker2 ?></u> !',
                                        type: 'error',
                                        confirmButtonText: 'OK',
                                        allowOutsideClick: false
                                        // timer: 2000,
