    ...
    <div class="col-12">
        ...
        <table id="table_ng_ng" class="table table-bordered">
            ...
            <tbody>
                <?php
                $no = 0;
                $sql = mysqli_query($connect_pro, "SELECT * FROM formng_listng WHERE c_area = 'outside' order by id asc");
                ...
                while ($data = mysqli_fetch_array($sql)) {
                    ...
                    $sql2 = mysqli_query($connect_pro, "SELECT COUNT(c_serialnumber) as total FROM formng_resultong WHERE c_ng = '$data[c_ng]' AND c_inspectiondate LIKE '$thismonth%'");
                    ...
                    //cek pada hasil pengecekan outside
                    $sql2 = mysqli_query($connect_pro, "SELECT COUNT(c_serialnumber) as total FROM formng_resultong WHERE c_ng = '$data[c_ng]' AND c_inspectiondate LIKE '$lastmonth%'");
                    $data2 = mysqli_fetch_array($sql2);
                    $total_ng2a = $data2['total'];
