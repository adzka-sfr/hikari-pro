<!-- <br> -->
<ul style="margin-top: 30px;" class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
    <li class="nav-item">
...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="furniture" role="tabpanel" aria-labelledby="furniture-tab">
        ...
        <ul style="margin-top: 30px;" class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
            ...
            $page = 'p';
            $urutan = 0;
            $sql = mysqli_query($connect_pro, "SELECT DISTINCT c_type FROM formng_checkcomplete WHERE c_group = '$page'");
            ...
            ?>
                <li class="nav-item">
                    <a class="nav-link <?= $label_active ?>" id="<?= $id ?>" data-toggle="tab" href="#<?= $id ?>" role="tab" aria-controls="<?= $id ?>" aria-selected="true"><?= $label ?></a>
                </li>
            <?php
            }
            ?>
            ...
            <div class="col-12">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $no = 0;
                        $sql = mysqli_query($connect_pro, "SELECT * FROM formng_checkcomplete WHERE c_type = 'f-P22' order by id asc");
