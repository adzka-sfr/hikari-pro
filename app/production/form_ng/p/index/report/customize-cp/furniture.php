...
<div class="row">
    <div class="col-7 tableFixHead-4">
        <table class="table table-bordered">
            <thead style="text-align: center;">
                ...
                <th>Completeness Process (Furniture)</th>
            </thead>
            <tbody>
                <?php
                $no  = 0;
                $sql = mysqli_query($connect_pro, "SELECT * FROM formng_checkcomplete WHERE c_type = 'f' order by id");
    ...
    <div class="col-5">
        <div class="row">
            <div class="col-12">
                <h5>Add Completeness Process (Furniture)</h5>
                <hr>
            </div>
        </div>
        <form method="post">
        ...
        <div class="row">
            <div class="col-12  mt-3">
                <h5>Enable/Disabled Completeness Process (Furniture)</h5>
                <hr>
            </div>
        </div>
        <form method="post">
            <div class="row">
                <div class="col-12">
                    <select class="cari_basic" style="width: 100% " required name="idprofur">
                        <option></option>
                        <?php
