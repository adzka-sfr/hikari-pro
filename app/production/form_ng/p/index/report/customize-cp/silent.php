...
<div class="row">
    <div class="col-7 tableFixHead-4">
        <table class="table table-bordered">
            <thead style="text-align: center;">
                ...
                <th>Completeness Process (Silent)</th>
            </thead>
            <tbody>
                <?php
                $no  = 0;
                $sql = mysqli_query($connect_pro, "SELECT * FROM formng_checkcomplete WHERE c_type = 's' order by id");
    ...
    <div class="col-5">
        <div class="row">
            <div class="col-12">
                <h5>Add Completeness Process (Silent)</h5>
                <hr>
            </div>
        </div>
        <form method="post">
            <div class="row">
                <div class="col-12">
                    <div class="form-floating">
                        <textarea class="form-control" name="prosil" placeholder="Type process here" id="floatingTextarea"></textarea>
            ...
            <div class="row">
                <div class="col-12" style="text-align: right;">
                    <button name="addprosil" class="btn btn-success" style="width: 100px;">Add</button>
                </div>
            </div>
        </form>

        <?php
        if (isset($_POST['addprosil'])) {
        ...
        <div class="row">
            <div class="col-12 mt-3">
                <h5>Enable/Disabled Completeness Process (Silent)</h5>
                <hr>
            </div>
        </div>
        <form method="post">
            <div class="row">
                <div class="col-12">
                    <select class="cari_basic" style="width: 100% " required name="idprosil">
                        <option></option>
                        <?php
            ...
            <div class="row">
                <div class="col-12" style="text-align: right;">
                    <button name="updateprosil" class="btn btn-primary" style="width: 100px;">Update</button>
                </div>
            </div>
        </form>
        <?php
        if (isset($_POST['updateprosil'])) {
            $id = $_POST['idprosil'];
