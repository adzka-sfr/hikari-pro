            ...
            <div class="col-md-3 left_col menu_fixed">
                ...
                <li><a href="<?= base_url('history') ?>"><i class="fa fa-history"></i> History</a>
                    ...
                    <div class="sidebar-footer hidden-small">
                        ...
                        <a style="color: inherit;" href="<?= base_url('panel/profile') ?>" data-toggle="tooltip" data-placement="top" title="Profile">
                            <span class="glyphicon glyphicon-user" aria-hidden="true"></span>
                        </a>
                        <a style="color: inherit;" href="<?= base_url('panel/settings') ?>" data-toggle="tooltip" data-placement="top" title="Settings">
