...
<body>
  <h1>oops!</h1>
  <h2>Please be patient, <b><u><?php echo $_SESSION['app_error'] ?></u></b> system is under development <b>:(</b></h2>
  ...
  <div class="row" style="margin-top: 220px; text-align: center;">
    <div class="col-md-12">
      <a href="../dashboard/"><button type="button" class="btn btn-round btn-success">Back to Dashboard</button></a>
    </div>
  </div>
</body>
